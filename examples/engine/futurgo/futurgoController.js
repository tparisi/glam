...
goog.inherits(FuturgoController, glam.Script);
...
FuturgoController.prototype.realize = function()
{
	...
	this.bouncer = new glam.BounceBehavior(
...
FuturgoController.prototype.testCollision = function() {
	...
	if (this.movementVector.length()) {
        ...
        collide = glam.Graphics.instance.objectFromRay(this.scene, this.eyePosition,
        		this.movementVector, 
...
FuturgoController.prototype.testTerrain = function() {
	...
	var terrainHit = glam.Graphics.instance.objectFromRay(this.scene, 
				this.eyePosition,
        		this.downVector);
