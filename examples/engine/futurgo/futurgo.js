...
Futurgo.prototype.go = function() {
	this.viewer = new glam.Viewer({ container : this.container, showGrid : true,
...
Futurgo.prototype.onLoadComplete = function(data, loadStartTime)
{
	...
	scene.map(/windows_front|windows_rear/, function(o) {
		var fader = new glam.FadeBehavior({duration:2, opacity:.8});
	...
	var carousel = new glam.RotateBehavior({autoStart:true, duration:20});
