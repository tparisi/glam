...
l=a.getAttribute("fontFamily")||glam.SurfaceElement.DEFAULT_FONT_FAMILY,p=a.getAttribute("fontWeight")||glam.SurfaceElement.DEFAULT_FONT_WEIGHT,q=a.getAttribute("fontStyle")||glam.SurfaceElement.DEFAULT_FONT_STYLE,s=a.getAttribute("fontSize")||glam.SurfaceElement.DEFAULT_FONT_SIZE,w=0,x=0,t=0,n=0,r=0,y=0;b&&(b.width&&(d=b.width),b.height&&(e=b.height),b.widthSegments&&(f=b.widthSegments),b.heightSegments&&(g=b.heightSegments),b.curvature&&(k=b.curvature),b.border&&(w=b.border),b["border-radius"]&&
(x=b["border-radius"]),n=b["border-top-radius"]?b["border-top-radius"]:x,t=b["border-left-radius"]?b["border-left-radius"]:x,r=b["border-right-radius"]?b["border-right-radius"]:x,y=b["border-bottom-radius"]?b["border-bottom-radius"]:x,b.color&&(h=b.color),b["background-color"]&&(m=b["background-color"]),b["font-family"]&&(l=b["font-family"]),b["font-weight"]&&(p=b["font-weight"]),b["font-style"]&&(q=b["font-style"]),b["font-size"]&&(s=b["font-size"]));b=a.getAttribute("value")||glam.SurfaceElement.DEFAULT_VALUE;
b||(b=a.textContent);d=parseFloat(d);e=parseFloat(e);f=parseInt(f);g=parseInt(g);k=parseInt(k);w=parseInt(w);x=parseInt(x);n=parseInt(n);t=parseInt(t);r=parseInt(r);y=parseInt(y);s=parseFloat(s);c.width=d;c.height=e;c.widthSegments=f;c.heightSegments=g;c.curvature=k;c.border=w;c.borderRadius=x;c.borderRadiusTop=n;c.borderRadiusLeft=t;c.borderRadiusRight=r;c.borderRadiusBottom=y;c.value=b;c.color=h;c.backgroundColor=m;c.fontFamily=l;c.fontWeight=p;c.fontStyle=q;c.fontSize=s};
glam.SurfaceElement.createVisual=function(a,b,c){a=b.clone();a.color.setRGB(1,1,1);a.map=glam.SurfaceElement.createTexture(c);a.transparent=!0;a.depthWrite=!1;return new glam.Visual({geometry:new THREE.PlaneGeometry(c.width,c.height,c.widthSegments,c.heightSegments),material:a})};
glam.SurfaceElement.createTexture=function(a){var b=a.height/a.width,c=document.createElement("canvas");c.width=1024;c.height=1024*b;b=c.getContext("2d");b.fillStyle="rgba(0, 0, 0, 0)";b.fillRect(0,0,c.width,c.height);b.fillStyle=a.backgroundColor;b.strokeStyle=a.color;b.lineWidth=a.border;glam.SurfaceElement.roundRect(b,0,0,c.width,c.height,{left:a.borderRadiusLeft,right:a.borderRadiusRight,top:a.borderRadiusTop,bottom:a.borderRadiusBottom},!0,a.border);b.font=a.fontStyle+" "+(1*a.fontSize).toString()+
"px "+a.fontFamily;b.fillStyle=a.color;b.fillText(a.value,20,100);a=new THREE.Texture(c);a.needsUpdate=!0;return a};
glam.SurfaceElement.roundRect=function(a,b,c,d,e,f,g,k){"undefined"==typeof k&&(k=!0);a.beginPath();a.moveTo(b+f.left,c);a.lineTo(b+d-f.right,c);a.quadraticCurveTo(b+d,c,b+d,c+f.top);a.lineTo(b+d,c+e-f.bottom);a.quadraticCurveTo(b+d,c+e,b+d-f.right,c+e);a.lineTo(b+f.left,c+e);a.quadraticCurveTo(b,c+e,b,c+e-f.bottom);a.lineTo(b,c+f.top);a.quadraticCurveTo(b,c,b+f.left,c);a.closePath();k&&a.stroke();g&&a.fill()};glam.LineElement={};glam.LineElement.create=function(a,b){var c=glam.DOMMaterial.create(b,null,"line"),d=new THREE.Geometry;glam.LineElement.parse(a,d,c);var e=new THREE.Line(d,c),f=new glam.Object,e=new glam.Visual({object:e});f.addComponent(e);a.geometry=d;a.material=c;return f};
...
glam.AnimationElement.build=function(a,b,c,d){var e=[],f=[],g=[],k=[],h=[],m=[],l=[],p=[],q=[],s=[],w,x=d.length;for(w=0;w<x;w++){var t=d[w],n=t.value;if("transform"==t.type){if("x"in n||"y"in n||"z"in n){e.push(t.time);var r={};"x"in n&&(r.x=n.x);"y"in n&&(r.y=n.y);"z"in n&&(r.z=n.z);f.push(r)}if("rx"in n||"ry"in n||"rz"in n)g.push(t.time),r={},"rx"in n&&(r.x=n.rx),"ry"in n&&(r.y=n.ry),"rz"in n&&(r.z=n.rz),k.push(r);if("sx"in n||"sy"in n||"sz"in n)h.push(t.time),r={},"sx"in n&&(r.x=n.sx),"sy"in n&&
(r.y=n.sy),"sz"in n&&(r.z=n.sz),m.push(r)}else"material"==t.type&&("opacity"in n&&(l.push(t.time),p.push({opacity:parseFloat(n.opacity)})),"color"in n&&(q.push(t.time),t=new THREE.Color(n.color),s.push({r:t.r,g:t.g,b:t.b})))}return{duration:a,loop:b,easing:c,poskeys:e,posvalues:f,rotkeys:g,rotvalues:k,sclkeys:h,sclvalues:m,opakeys:l,opavalues:p,colorkeys:q,colorvalues:s}};
...
l=a.getAttribute("bevelThickness")||glam.TextElement.DEFAULT_BEVEL_THICKNESS,p=a.getAttribute("fontRender")||glam.TextElement.DEFAULT_FONT_RENDER,q=a.getAttribute("width")||glam.TextElement.DEFAULT_WIDTH,s=a.getAttribute("height")||glam.TextElement.DEFAULT_HEIGHT;b&&(b["font-family"]&&(d=b["font-family"]),b["font-weight"]&&(e=b["font-weight"]),b["font-style"]&&(f=b["font-style"]),b["font-size"]&&(g=b["font-size"]),b["font-depth"]&&(k=b["font-depth"]),b["font-bevel"]&&(h=b["font-bevel"]),b["bevel-size"]&&
...
h=!0);var w=a.getAttribute("value")||glam.TextElement.DEFAULT_VALUE;w||(w=a.textContent);c.value=w;c.fontSize=g;c.fontDepth=k;c.bevelSize=m;c.bevelThickness=l;c.bevelEnabled=h;c.fontFamily=d;c.fontWeight=e;c.fontStyle=f;c.fontRender=p;c.width=q;c.height=s;b&&(c.color=b.color)};glam.TextElement.createVisual=function(a,b,c){return c.value?"polygon"==c.fontRender?glam.TextElement.createPolygonText(a,b,c):"bitmap"==c.fontRender?glam.TextElement.createBitmapText(a,b,c):null:null};
...
0,q=parseFloat(a.getAttribute("vz"))||0,s=parseFloat(a.getAttribute("ax"))||0,w=parseFloat(a.getAttribute("ay"))||0,x=parseFloat(a.getAttribute("az"))||0,t=parseFloat(a.getAttribute("psx"))||0,n=parseFloat(a.getAttribute("psy"))||0,r=parseFloat(a.getAttribute("psz"))||0,y=parseFloat(a.getAttribute("asx"))||0,u=parseFloat(a.getAttribute("asy"))||0,B=parseFloat(a.getAttribute("asz"))||0;l=new THREE.Vector3(l,p,q);s=new THREE.Vector3(s,w,x);t=new THREE.Vector3(t,n,r);y=new THREE.Vector3(y,u,B);(u=a.getAttribute("velocity"))&&
glam.DOMTypes.parseVector3(u,l);(u=a.getAttribute("acceleration"))&&glam.DOMTypes.parseVector3(u,s);(u=a.getAttribute("positionSpread"))&&glam.DOMTypes.parseVector3(u,t);(u=a.getAttribute("accelerationSpread"))&&glam.DOMTypes.parseVector3(u,y);u=THREE.NoBlending;switch((a.getAttribute("blending")||"").toLowerCase()){case "normal":u=THREE.NormalBlending;break;case "additive":u=THREE.AdditiveBlending;break;case "subtractive":u=THREE.SubtractiveBlending;break;case "multiply":u=THREE.MultiplyBlending;
break;case "custom":u=THREE.CustomBlending}b.size=c;b.sizeEnd=d;void 0!==h&&(b.colorStart=h);void 0!==m&&(b.colorEnd=m);b.particlesPerSecond=e;b.opacityStart=f;b.opacityMiddle=g;b.opacityEnd=k;b.velocity=l;b.acceleration=s;b.positionSpread=t;b.accelerationSpread=y;b.blending=u};glam.ParticlesElement.addEmitters=function(a,b){var c,d=a.length;for(c=0;c<d;c++)b.addComponent(a[c])};glam.ParticlesElement.DEFAULT_MAX_AGE=1;glam.BackgroundElement={};glam.BackgroundElement.DEFAULT_BACKGROUND_TYPE="box";
...
glam.DOMTypes.parseFaceArray=function(a,b){var c=a.textContent.match(/\S+/g);if(c){var d,e=c.length;if(!(1>e))for(d=0;d<e;d+=3){var f=parseInt(c[d]),g=parseInt(c[d+1]),k=parseInt(c[d+2]),f=new THREE.Face3(f,g,k);b.push(f)}}};glam.DOMTypes.parseUVArray=function(a,b){var c=a.textContent.match(/\S+/g);if(c){var d,e=c.length;if(!(6>e))for(d=0;d<e;d+=6){for(var f=[],g=0;3>g;g++){var k=parseFloat(c[d+2*g]),h=parseFloat(c[d+2*g+1]),k=new THREE.Vector2(k,h);f.push(k)}b.push(f)}}};glam.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*l.autoRotateSpeed}function d(a){!1!==l.enabled&&!1!==l.userRotate&&(a.preventDefault(),0===a.button||l.oneButton&&2===a.button?(A=z.ROTATE,q.set(a.clientX,a.clientY)):1===a.button&&l.userZoom?(A=z.ZOOM,x.set(a.clientX,a.clientY)):2===a.button&&l.userPan&&(A=z.PAN),l.domElement.addEventListener("mousemove",e,!1),l.domElement.addEventListener("mouseup",k,!1),l.domElement.addEventListener("touchmove",f,!1),l.domElement.addEventListener("touchend",
h,!1))}function e(a){!1!==l.enabled&&(a.preventDefault(),A===z.ROTATE?(s.set(a.clientX,a.clientY),w.subVectors(s,q),l.rotateLeft(2*Math.PI*w.x/p*l.userRotateSpeed),l.rotateUp(2*Math.PI*w.y/p*l.userRotateSpeed),q.copy(s)):A===z.ZOOM?(t.set(a.clientX,a.clientY),n.subVectors(t,x),0<n.y?l.zoomIn():l.zoomOut(),x.copy(t)):A===z.PAN&&l.pan(new THREE.Vector3(-(a.movementX||a.mozMovementX||a.webkitMovementX||0),a.movementY||a.mozMovementY||a.webkitMovementY||0,0)))}function f(a){if(!1!==l.enabled)if(1<a.changedTouches.length){for(var b=
...
this.userZoom=!0;this.userZoomSpeed=1;this.userRotate=!0;this.userRotateSpeed=1;this.userPan=!0;this.userPanSpeed=2;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.minDistance=0;this.maxDistance=Infinity;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.usekeys=this.oneButton=!1;var l=this,p=1800,q=new THREE.Vector2,s=new THREE.Vector2,w=new THREE.Vector2,x=new THREE.Vector2,t=new THREE.Vector2,n=new THREE.Vector2,r=0,y=0,u=1,B=new THREE.Vector3,z={NONE:-1,
ROTATE:0,ZOOM:1,PAN:2},A=z.NONE,C={type:"change"};this.rotateLeft=function(a){void 0===a&&(a=c());y-=a};this.rotateRight=function(a){void 0===a&&(a=c());y+=a};this.rotateUp=function(a){void 0===a&&(a=c());r-=a};this.rotateDown=function(a){void 0===a&&(a=c());r+=a};this.zoomIn=function(a){void 0===a&&(a=Math.pow(1/0.95,l.userZoomSpeed));u/=a};this.zoomOut=function(a){void 0===a&&(a=Math.pow(1/0.95,l.userZoomSpeed));u*=a};this.pan=function(a){a.transformDirection(this.object.matrix);a.multiplyScalar(l.userPanSpeed);
this.object.position.add(a);this.center.add(a)};this.update=function(){if(!1!==this.enabled){var a=this.object.position,b=a.clone().sub(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&this.rotateLeft(c());var d=d+y,e=e+r,e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),f=b.length()*u,f=Math.max(this.minDistance,Math.min(this.maxDistance,f));b.x=f*Math.sin(e)*Math.sin(d);b.y=f*Math.cos(e);b.z=f*
Math.sin(e)*Math.cos(d);a.copy(this.center).add(b);this.object.lookAt(this.center);r=y=0;u=1;0<B.distanceTo(this.object.position)&&(this.dispatchEvent(C),B.copy(this.object.position))}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",d,!1);this.domElement.addEventListener("touchstart",function(a){1<a.touches.length?(l.touchDistance=g(a.touches[0],a.touches[1]),l.touchId0=a.touches[0].identifier,l.touchId1=a.touches[1].identifier):
