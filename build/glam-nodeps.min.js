...
glam.SkyboxScript.prototype.realize=function(){this.uniforms=this._object.getComponent(glam.Visual).material.uniforms;this.camera=glam.Graphics.instance.backgroundLayer.camera;this.camera.far=2E4;this.camera.position.set(0,0,0)};glam.SkyboxScript.prototype.update=function(){var a=glam.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};glam.SurfaceElement={};glam.SurfaceElement.DEFAULT_WIDTH=2;glam.SurfaceElement.DEFAULT_HEIGHT=2;glam.SurfaceElement.DEFAULT_WIDTH_SEGMENTS=1;glam.SurfaceElement.DEFAULT_CURVATURE=0;glam.SurfaceElement.DEFAULT_VALUE="";glam.SurfaceElement.DEFAULT_COLOR="black";glam.SurfaceElement.DEFAULT_BACKGROUND_COLOR="white";glam.SurfaceElement.DEFAULT_FONT_FAMILY="helvetica";glam.SurfaceElement.DEFAULT_FONT_WEIGHT="normal";glam.SurfaceElement.DEFAULT_FONT_STYLE="normal";glam.SurfaceElement.DEFAULT_FONT_SIZE=10;
glam.SurfaceElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.SurfaceElement)};
...
glam.SurfaceElement.createVisual=function(a,b,c){a=b.clone();a.map=glam.SurfaceElement.createTexture(c);a.transparent=!0;a.depthWrite=!1;return new glam.Visual({geometry:new THREE.PlaneGeometry(c.width,c.height,c.widthSegments,c.heightSegments),material:a})};
