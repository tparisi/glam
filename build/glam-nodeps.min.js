...
glam.GraphicsThreeJS.prototype.onDocumentMouseDown=function(a){a.preventDefault();var b={};this.calcElementOffset(b);a={type:a.type,pageX:a.pageX,pageY:a.pageY,elementX:a.pageX-b.left,elementY:a.pageY-b.top,button:a.button,altKey:a.altKey,ctrlKey:a.ctrlKey,shiftKey:a.shiftKey};glam.Mouse.instance.onMouseDown(a);glam.PickManager&&glam.PickManager.handleMouseDown(a);glam.ViewPicker&&glam.ViewPicker.handleMouseDown(a);glam.Application.handleMouseDown(a)};
glam.GraphicsThreeJS.prototype.onDocumentMouseUp=function(a){a.preventDefault();var b={};this.calcElementOffset(b);a={type:a.type,pageX:a.pageX,pageY:a.pageY,elementX:a.pageX-b.left,elementY:a.pageY-b.top,button:a.button,altKey:a.altKey,ctrlKey:a.ctrlKey,shiftKey:a.shiftKey};glam.Mouse.instance.onMouseUp(a);glam.PickManager&&glam.PickManager.handleMouseUp(a);glam.ViewPicker&&glam.ViewPicker.handleMouseUp(a);glam.Application.handleMouseUp(a)};
...
glam.GraphicsThreeJS.prototype.onWindowResize=function(a){a=this.container.offsetWidth;var b=this.container.offsetHeight;this.riftCam&&this.riftCam._vrHMD&&(a=window.innerWidth,b=window.innerHeight);this.cardboard&&this.cardboard.setSize(a,b);this.renderer.setSize(a,b);this.composer&&this.composer.setSize(a,b);glam.CameraManager&&glam.CameraManager.handleWindowResize(this.container.offsetWidth,this.container.offsetHeight)||(this.camera.aspect=this.container.offsetWidth/this.container.offsetHeight,
this.camera.updateProjectionMatrix());this.backgroundLayer&&this.backgroundLayer.camera&&(this.backgroundLayer.camera.aspect=this.container.offsetWidth/this.container.offsetHeight,this.backgroundLayer.camera.updateProjectionMatrix())};glam.GraphicsThreeJS.prototype.onFullScreenChanged=function(a){this.fullscreen=document.mozFullscreenElement||document.webkitFullscreenElement?!0:!1};glam.GraphicsThreeJS.prototype.setCursor=function(a){a||(a=this.saved_cursor);this.container.style.cursor=a};
glam.GraphicsThreeJS.prototype.update=function(){var a=Date.now(),b=(a-this.lastFrameTime)/1E3;this.frameRate=1/b;this.lastFrameTime=a;glam.ViewPicker&&glam.ViewPicker.update();this.composer?this.renderEffects(b):this.cardboard?this.renderStereo():this.riftCam&&this.riftCam._vrHMD?this.renderVR():this.render();this.stats&&this.stats.update()};
...
glam.FirstPersonControllerScript=function(a){glam.Script.call(this,a);this._enabled=void 0!==a.enabled?a.enabled:!0;this._move=void 0!==a.move?a.move:!0;this._look=void 0!==a.look?a.look:!0;this._turn=void 0!==a.turn?a.turn:!0;this._tilt=void 0!==a.tilt?a.tilt:!0;this._mouseLook=void 0!==a.mouseLook?a.mouseLook:!1;this._useArrows=void 0!==a.useArrows?a.useArrows:!0;this._useWASD=void 0!==a.useWASD?a.useWASD:!0;this.testCollisions=void 0!==a.testCollisions?a.testCollisions:!1;this.collisionDistance=
10;this.moveSpeed=13;this.tiltSpeed=this.turnSpeed=5;this.lookSpeed=1;this.savedCameraPos=new THREE.Vector3;this.movementVector=new THREE.Vector3;Object.defineProperties(this,{camera:{get:function(){return this._camera},set:function(a){this.setCamera(a)}},enabled:{get:function(){return this._enabled},set:function(a){this.setEnabled(a)}},move:{get:function(){return this._move},set:function(a){this.setMove(a)}},look:{get:function(){return this._look},set:function(a){this.setLook(a)}},mouseLook:{get:function(){return this._mouseLook},
set:function(a){this.setMouseLook(a)}},headlightOn:{get:function(){return this._headlightOn},set:function(a){this.setHeadlightOn(a)}}})};goog.inherits(glam.FirstPersonControllerScript,glam.Script);glam.FirstPersonControllerScript.prototype.realize=function(){this.headlight=this._object.getComponent(glam.DirectionalLight);this.headlight.intensity=this._headlightOn?1:0};
glam.FirstPersonControllerScript.prototype.createControls=function(a){a=new glam.FirstPersonControls(a.object,glam.Graphics.instance.container);a.mouseLook=this._mouseLook;a.movementSpeed=this._move?this.moveSpeed:0;a.lookSpeed=this._look?this.lookSpeed:0;a.turnSpeed=this._turn?this.turnSpeed:0;a.tiltSpeed=this._tilt?this.tiltSpeed:0;a.useArrows=this._useArrows;a.useWASD=this._useWASD;this.clock=new THREE.Clock;return a};
...
glam.VisualElement.addProperties=function(a,b){var c=b.getComponents(glam.Visual)[0];c&&(a.geometry=c.geometry,a.material=c.material)};glam.DOMViewer=function(a){this.document=a;this.documentParent=a.parentElement;this.riftRender=glam.DOM.riftRender||!1;this.cardboardRender=glam.DOM.cardboardRender||!1;this.displayStats=glam.DOM.displayStats||!1;glam.DOMViewer.instance=this};glam.DOMViewer.prototype={};
...
glam.DOMViewer.prototype.initDefaultScene=function(){this.scene=new glam.Object;this.app.sceneRoot.addChild(this.scene);this.app.defaultCamera.position.set(0,0,5)};glam.DOMViewer.prototype.traverseScene=function(){var a=this.document.getElementsByTagName("scene");a?(a=a[0],glam.DOMElement.init(a),a.glam.object=this.scene,this.traverse(a,this.scene)):console.warn("Document error! glam requires one 'scene' element")};
...
glam.DOMViewer.prototype.addNode=function(a){var b=a.tagName;b&&(b=b.toLowerCase());var c=null;if((b=b?glam.DOMTypes.types[b]:null)&&b.cls&&(c=b.cls.create)&&"function"==typeof c)if(a.glam)c=a.glam.object,c._parent||(b=a.parentElement)&&b.glam&&b.glam.object.addChild(c);else{glam.DOMElement.init(a);var d=glam.DOMElement.getStyle(a);if(c=c.call(this,a,d,this.app))a.glam.object=c,this.addFeatures(a,d,c,b),this.scene.addChild(c),this.traverse(a,c)}a=a.childNodes;b=a.length;for(c=0;c<b;c++)this.addNode(a[c])};
glam.DOMViewer.prototype.removeNode=function(a){(a=a.glam.object)&&a._parent.removeChild(a)};glam.DOMViewer.prototype.createElement=function(a){var b=a;b&&(b=b.toLowerCase());var c=null;if((b=b?glam.DOMTypes.types[b]:null)&&b.cls&&(c=b.cls.create)&&"function"==typeof c){a=document.createElement(a);glam.DOMElement.init(a);var d=glam.DOMElement.getStyle(a);if(c=c.call(this,a,d,this.app))a.glam.object=c,this.addFeatures(a,d,c,b);return a}return null};
...
glam.SkyboxScript.prototype.realize=function(){this.uniforms=this._object.getComponent(glam.Visual).material.uniforms;this.camera=glam.Graphics.instance.backgroundLayer.camera;this.camera.far=2E4;this.camera.position.set(0,0,0)};glam.SkyboxScript.prototype.update=function(){var a=glam.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};glam.SurfaceElement={};glam.SurfaceElement.DEFAULT_WIDTH=2;glam.SurfaceElement.DEFAULT_HEIGHT=2;glam.SurfaceElement.DEFAULT_WIDTH_SEGMENTS=16;glam.SurfaceElement.DEFAULT_HEIGHT_SEGMENTS=16;glam.SurfaceElement.DEFAULT_CURVATURE=0;glam.SurfaceElement.DEFAULT_VALUE="";glam.SurfaceElement.DEFAULT_COLOR="black";glam.SurfaceElement.DEFAULT_BACKGROUND_COLOR="white";glam.SurfaceElement.DEFAULT_FONT_FAMILY="helvetica";glam.SurfaceElement.DEFAULT_FONT_WEIGHT="normal";
glam.SurfaceElement.DEFAULT_FONT_STYLE="normal";glam.SurfaceElement.DEFAULT_FONT_SIZE=10;glam.SurfaceElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.SurfaceElement)};
glam.SurfaceElement.getAttributes=function(a,b,c){var d=a.getAttribute("width")||glam.SurfaceElement.DEFAULT_WIDTH,e=a.getAttribute("height")||glam.SurfaceElement.DEFAULT_HEIGHT,f=a.getAttribute("width")||glam.SurfaceElement.DEFAULT_WIDTH_SEGMENTS,g=a.getAttribute("height")||glam.SurfaceElement.DEFAULT_HEIGHT_SEGMENTS,k=a.getAttribute("curvature")||glam.SurfaceElement.DEFAULT_CURVATURE,h=a.getAttribute("color")||glam.SurfaceElement.DEFAULT_COLOR,m=a.getAttribute("backgroundColor")||glam.SurfaceElement.DEFAULT_BACKGROUND_COLOR,
l=a.getAttribute("fontFamily")||glam.SurfaceElement.DEFAULT_FONT_FAMILY,p=a.getAttribute("fontWeight")||glam.SurfaceElement.DEFAULT_FONT_WEIGHT,q=a.getAttribute("fontStyle")||glam.SurfaceElement.DEFAULT_FONT_STYLE,u=a.getAttribute("fontSize")||glam.SurfaceElement.DEFAULT_FONT_SIZE,w=a.getAttribute("element"),y=0,r=0,n=0,s=0,x=0,t=0;b&&(b.width&&(d=b.width),b.height&&(e=b.height),b.widthSegments&&(f=b.widthSegments),b.heightSegments&&(g=b.heightSegments),b.curvature&&(k=b.curvature),b.border&&(y=b.border),
b["border-radius"]&&(r=b["border-radius"]),s=b["border-top-radius"]?b["border-top-radius"]:r,n=b["border-left-radius"]?b["border-left-radius"]:r,x=b["border-right-radius"]?b["border-right-radius"]:r,t=b["border-bottom-radius"]?b["border-bottom-radius"]:r,b.color&&(h=b.color),b["background-color"]&&(m=b["background-color"]),b["font-family"]&&(l=b["font-family"]),b["font-weight"]&&(p=b["font-weight"]),b["font-style"]&&(q=b["font-style"]),b["font-size"]&&(u=b["font-size"]));b=a.getAttribute("value")||
glam.SurfaceElement.DEFAULT_VALUE;b||(b=a.textContent);d=parseFloat(d);e=parseFloat(e);f=parseInt(f);g=parseInt(g);k=parseInt(k);y=parseInt(y);r=parseInt(r);s=parseInt(s);n=parseInt(n);x=parseInt(x);t=parseInt(t);u=parseFloat(u);c.width=d;c.height=e;c.widthSegments=f;c.heightSegments=g;c.curvature=k;c.border=y;c.borderRadius=r;c.borderRadiusTop=s;c.borderRadiusLeft=n;c.borderRadiusRight=x;c.borderRadiusBottom=t;c.value=b;c.color=h;c.backgroundColor=m;c.fontFamily=l;c.fontWeight=p;c.fontStyle=q;c.fontSize=
u;c.elementID=w;c.docelt=a};glam.SurfaceElement.createVisual=function(a,b,c){a=b.clone();a.color.setRGB(1,1,1);a.map=glam.SurfaceElement.createTexture(c);a.transparent=!0;a.depthWrite=!1;return new glam.Visual({geometry:new THREE.PlaneGeometry(c.width,c.height,c.widthSegments,c.heightSegments),material:a})};
glam.SurfaceElement.createTexture=function(a){var b=a.height/a.width,c=document.createElement("canvas");c.width=1024;c.height=1024*b;b=c.getContext("2d");b.fillStyle="rgba(0, 0, 0, 0)";b.fillRect(0,0,c.width,c.height);a.elementID&&glam.SurfaceElement.createHTMLTexture(a);b.fillStyle=a.backgroundColor;b.strokeStyle=a.color;b.lineWidth=a.border;glam.SurfaceElement.roundRect(b,0,0,c.width,c.height,{left:a.borderRadiusLeft,right:a.borderRadiusRight,top:a.borderRadiusTop,bottom:a.borderRadiusBottom},!0,
a.border);b.font=a.fontStyle+" "+(1*a.fontSize).toString()+"px "+a.fontFamily;b.fillStyle=a.color;b.fillText(a.value,20,100);a=new THREE.Texture(c);a.needsUpdate=!0;return a};
glam.SurfaceElement.roundRect=function(a,b,c,d,e,f,g,k){"undefined"==typeof k&&(k=!0);a.beginPath();a.moveTo(b+f.left,c);a.lineTo(b+d-f.right,c);a.quadraticCurveTo(b+d,c,b+d,c+f.top);a.lineTo(b+d,c+e-f.bottom);a.quadraticCurveTo(b+d,c+e,b+d-f.right,c+e);a.lineTo(b+f.left,c+e);a.quadraticCurveTo(b,c+e,b,c+e-f.bottom);a.lineTo(b,c+f.top);a.quadraticCurveTo(b,c,b+f.left,c);a.closePath();k&&a.stroke();g&&a.fill()};
glam.SurfaceElement.createHTMLTexture=function(a){var b=document.getElementById(a.elementID).cloneNode(!0);document.body.appendChild(b);var c=a.docelt;html2canvas(b).then(function(a){document.body.removeChild(b);a=new THREE.Texture(a);a.needsUpdate=!0;var e=c.glam.object,f=e.visuals[0],g=f.geometry.clone(),k=f.material.clone();k.map=a;f.material.color.setRGB(1,0,0);e.removeComponent(f);f=new glam.Visual({geometry:g,material:k});e.addComponent(f)})};glam.LineElement={};glam.LineElement.create=function(a,b){var c=glam.DOMMaterial.create(b,null,"line"),d=new THREE.Geometry;glam.LineElement.parse(a,d,c);var e=new THREE.Line(d,c),f=new glam.Object,e=new glam.Visual({object:e});f.addComponent(e);a.geometry=d;a.material=c;return f};
...
glam.Application.prototype.onKeyUp=function(a){if(this.keyboardDelegate&&this.keyboardDelegate.onKeyUp)this.keyboardDelegate.onKeyUp(a)};glam.Application.prototype.onKeyPress=function(a){if(this.keyboardDelegate&&this.keyboardDelegate.onKeyPress)this.keyboardDelegate.onKeyPress(a)};glam.Application.instance=null;glam.Application.curObjectID=0;glam.Application.minFrameTime=1;glam.Application.handleMouseMove=function(a){if(glam.Application.instance.onMouseMove)glam.Application.instance.onMouseMove(a)};
glam.Application.handleMouseDown=function(a){glam.Application.instance.tabstop&&glam.Application.instance.focus();if(glam.Application.instance.onMouseDown)glam.Application.instance.onMouseDown(a)};glam.Application.handleMouseUp=function(a){if(glam.Application.instance.onMouseUp)glam.Application.instance.onMouseUp(a)};glam.Application.handleMouseClick=function(a){if(glam.Application.instance.onMouseClick)glam.Application.instance.onMouseClick(a)};glam.Application.handleMouseDoubleClick=function(a){if(glam.Application.instance.onMouseDoubleClick)glam.Application.instance.onMouseDoubleClick(a)};
glam.Application.handleMouseScroll=function(a){if(glam.Application.instance.onMouseScroll)glam.Application.instance.onMouseScroll(a)};glam.Application.handleTouchStart=function(a){if(glam.Application.instance.onTouchStart)glam.Application.instance.onTouchStart(a)};glam.Application.handleTouchMove=function(a){if(glam.Application.instance.onTouchMove)glam.Application.instance.onTouchMove(a)};glam.Application.handleTouchEnd=function(a){if(glam.Application.instance.onTouchEnd)glam.Application.instance.onTouchEnd(a)};
...
glam.Application.prototype.onTouchStart=function(a){if(this.touchDelegate&&this.touchDelegate.onTouchStart)this.touchDelegate.onTouchStart(a)};glam.Application.prototype.onTouchEnd=function(a){if(this.touchDelegate&&this.touchDelegate.onTouchEnd)this.touchDelegate.onTouchEnd(a)};glam.ViewPicker=function(a){a=a||{};glam.Component.call(this,a);this.enabled=void 0!==a.enabled?a.enabled:!0};goog.inherits(glam.ViewPicker,glam.Component);glam.ViewPicker.prototype._componentCategory="viewpickers";glam.ViewPicker.prototype.realize=function(){glam.Component.prototype.realize.call(this)};glam.ViewPicker.prototype.onViewOver=function(){this.dispatchEvent("viewover",{type:"viewover"})};glam.ViewPicker.prototype.onViewOut=function(){this.dispatchEvent("viewout",{type:"viewout"})};
glam.ViewPicker.prototype.onViewMouseDown=function(){this.dispatchEvent("mousedown",{type:"mousedown"})};glam.ViewPicker.prototype.onViewMouseUp=function(){this.dispatchEvent("mouseup",{type:"mouseup"})};glam.ViewPicker.prototype.onViewMouseClick=function(){this.dispatchEvent("click",{type:"click"})};glam.ViewPicker.handleMouseDown=function(a){glam.ViewPicker.clickedObject=glam.ViewPicker.overObject;if(glam.ViewPicker.clickedObject)glam.ViewPicker.clickedObject.onViewMouseDown()};
glam.ViewPicker.handleMouseUp=function(a){glam.ViewPicker.clickedObject&&(glam.ViewPicker.clickedObject.onViewMouseUp(),glam.ViewPicker.clickedObject.onViewMouseClick());glam.ViewPicker.clickedObject=null};glam.ViewPicker.update=function(){var a=glam.ViewPicker.overObject;glam.ViewPicker.overObject=glam.ViewPicker.objectFromView();if(glam.ViewPicker.overObject!=a){if(a)a.onViewOut();if(glam.ViewPicker.overObject)glam.ViewPicker.overObject.onViewOver()}};
glam.ViewPicker.objectFromView=function(a){this.origin.set(0,0,0);this.origin.applyMatrix4(glam.Graphics.instance.camera.matrixWorld);this.direction.set(0,0,-1);this.direction.transformDirection(glam.Graphics.instance.camera.matrixWorld);this.raycaster.set(this.origin,this.direction);this.raycaster.near=glam.Graphics.instance.camera.near;this.raycaster.far=glam.Graphics.instance.camera.far;var b=this.raycaster.intersectObjects(glam.Graphics.instance.scene.children,!0);if(0<b.length){for(a=0;a<b.length&&
!b[a].object.visible;)a++;var c=b[a]}if(c&&c.object){if((a=glam.ViewPicker.findObjectFromIntersected(c.object))&&a.viewpickers){var b=a.viewpickers,d=b.length;for(a=0;a<d;a++)if(b[a].enabled)return b[a]}return glam.ViewPicker.findObjectPicker(c.object)}return null};glam.ViewPicker.findObjectFromIntersected=function(a){return a.data?a.data:a.parent?glam.ViewPicker.findObjectFromIntersected(a.parent):null};
glam.ViewPicker.findObjectPicker=function(a){for(;a;){if(a.data&&a.data._object.viewpickers){var b=a.data._object.viewpickers,c,d=b.length;for(c=0;c<d;c++)if(b[c].enabled)return b[c]}a=a.parent}return null};glam.ViewPicker.origin=new THREE.Vector3;glam.ViewPicker.direction=new THREE.Vector3;glam.ViewPicker.raycaster=new THREE.Raycaster;glam.ViewPicker.overObject=null;glam.ViewPicker.clickedObject=null;glam.DOMClassList=function(a){this.docelt=a;Array.call(this)};glam.DOMClassList.prototype=[];glam.DOMClassList.prototype.item=function(a){return this[a]};glam.DOMClassList.prototype.add=function(a){a=this.push(a);this.updateElement();return a};glam.DOMClassList.prototype.remove=function(a){a=this.indexOf(a);-1!=a&&(this.splice(a,1),this.updateElement())};glam.DOMClassList.prototype.updateElement=function(){};glam.ParticleEmitter=function(a){this.param=a||{};glam.Component.call(this,a);a=this.param.size||glam.ParticleEmitter.DEFAULT_SIZE;var b=this.param.sizeEnd||glam.ParticleEmitter.DEFAULT_SIZE_END,c=this.param.colorStart||glam.ParticleEmitter.DEFAULT_COLOR_START,d=this.param.colorEnd||glam.ParticleEmitter.DEFAULT_COLOR_END,e=this.param.particlesPerSecond||glam.ParticleEmitter.DEFAULT_PARTICLES_PER_SECOND,f=this.param.opacityStart||glam.ParticleEmitter.DEFAULT_OPACITY_START,g=this.param.opacityMiddle||
glam.ParticleEmitter.DEFAULT_OPACITY_MIDDLE,k=this.param.opacityEnd||glam.ParticleEmitter.DEFAULT_OPACITY_END,h=this.param.velocity||glam.ParticleEmitter.DEFAULT_VELOCITY,m=this.param.acceleration||glam.ParticleEmitter.DEFAULT_ACCELERATION,l=this.param.positionSpread||glam.ParticleEmitter.DEFAULT_POSITION_SPREAD,p=this.param.accelerationSpread||glam.ParticleEmitter.DEFAULT_ACCELERATION_SPREAD,q=this.param.blending||glam.ParticleEmitter.DEFAULT_BLENDING;this._active=!1;this.object=new ShaderParticleEmitter({size:a,
sizeEnd:b,colorStart:c,colorEnd:d,particlesPerSecond:e,opacityStart:f,opacityMiddle:g,opacityEnd:k,velocity:h,acceleration:m,positionSpread:l,accelerationSpread:p,blending:q});Object.defineProperties(this,{active:{get:function(){return this._active},set:function(a){this.setActive(a)}}})};goog.inherits(glam.ParticleEmitter,glam.Component);glam.ParticleEmitter.prototype.realize=function(){};glam.ParticleEmitter.prototype.update=function(){};
...
if(a["backface-visibility"])switch(a["backface-visibility"].toLowerCase()){case "visible":h=THREE.DoubleSide;break;case "hidden":h=THREE.FrontSide}var l;a["render-mode"]&&(l="wireframe"==a["render-mode"]);var p;a["line-width"]&&(p=parseInt(a["line-width"]));var q;a["dash-size"]&&(q=parseInt(a["dash-size"]));var u;a["gap-size"]&&(u=parseInt(a["gap-size"]));a={};var w=new THREE.TextureLoader;b.image&&(a.map=w.load(b.image));b.envMap&&(a.envMap=b.envMap);b.normalMap&&(a.normalMap=w.load(b.normalMap));
b.bumpMap&&(a.bumpMap=w.load(b.bumpMap));b.specularMap&&(a.specularMap=w.load(b.specularMap));void 0!==e&&(a.color=e);void 0!==f&&(a.color=f);void 0!==g&&(a.specular=g);void 0!==k&&(a.ambient=k);void 0!==m&&(a.opacity=m,a.transparent=1>m);void 0!==l&&(a.wireframe=l);void 0!==p&&(a.linewidth=p);void 0!==q&&(a.dashSize=q);void 0!==u&&(a.gapSize=u);void 0!==c&&(a.reflectivity=c);void 0!==d&&(a.refractionRatio=d);a.side=h;return a};
...
return 6==b.length?(a=new THREE.CubeTextureLoader,a.load(b,function(a){})):a["sphere-image"]?(b=glam.DOMMaterial.parseUrl(a["sphere-image"]),a=new THREE.TextureLoader,a.load(b,THREE.SphericalRefractionMapping,function(a){})):null};
...
(function(a){function b(a){a=g[a].replace(/^{|}parser/g,"");a=c(a);var b={};a.split(";").forEach(function(a){a=a.split(":");2>a.length||(b[d(a[0])]=d(a.slice(1).join(":")))});return b}function c(a,b){var c,d;a=a.replace(m,"parser1").replace(l,function(a,b){if(!b)return"";var c="%s`"+ ++q+"`s%";g[q]=b.replace(/^\\/,"");return c});for(var e=b?h:k;c=e.exec(a);)d="%b`"+ ++q+"`b%",g[q]=c[0],a=a.replace(e,d);return a}function d(a){var b;if(void 0===a)return a;for(;b=p.exec(a);)a=a.replace(p,g[b[1]]);return a.trim()}
...
m=/\/\*@((?:[^\*]|\*[^\/])*)\*\//g,l=/(?:\/\*(?:[^\*]|\*[^\/])*\*\/)|(\\.|"(?:[^\\\"]|\\.|\\\n)*"|'(?:[^\\\']|\\.|\\\n)*')/g,p=/%\w`(\d+)`\w%/,q=0,u=/\x3c!--([^-]|-[^-])*--\x3e/g,w=/(>)[^<]*/g,y=/<(\w+)([^>]*)>/g})(glam.CSSParser);glam.AnimationElement={};glam.AnimationElement.DEFAULT_DURATION="1s";glam.AnimationElement.DEFAULT_ITERATION_COUNT="1";glam.AnimationElement.DEFAULT_TIMING_FUNCTION="linear";glam.AnimationElement.DEFAULT_FRAME_TIME="0%";glam.AnimationElement.DEFAULT_FRAME_PROPERTY="transform";
...
b.split("\\s+"),a=f[0],d=f[1],e=f[2],f=f[4];d=d||glam.AnimationElement.DEFAULT_DURATION;d=glam.AnimationElement.parseTime(d);e=e||glam.AnimationElement.DEFAULT_TIMING_FUNCTION;e=glam.AnimationElement.parseTimingFunction(e);f=f||glam.AnimationElement.DEFAULT_ITERATION_COUNT;f="infinite"==f.toLowerCase()?!0:!1;if(a){a=glam.DOM.getStyle(a);b=[];for(var g in a){var k;k="from"==g?0:"to"==g?1:glam.AnimationElement.parseFrameTime(g);var h,m=a[g],l;for(l in m){var p=m[l],q;if("transform"==l||"-webkit-transform"==
l||"-moz-transform"==l)q="transform",h={},glam.DOMTransform.parseTransform(p,h);else if("opacity"==l||"color"==l)q="material",h=glam.DOMMaterial.parseStyle(m);b.push({time:k,value:h,type:q})}}d=glam.AnimationElement.build(d,f,e,b);glam.AnimationElement.addAnimationToObject(d,c)}};
glam.AnimationElement.build=function(a,b,c,d){var e=[],f=[],g=[],k=[],h=[],m=[],l=[],p=[],q=[],u=[],w,y=d.length;for(w=0;w<y;w++){var r=d[w],n=r.value;if("transform"==r.type){if("x"in n||"y"in n||"z"in n){e.push(r.time);var s={};"x"in n&&(s.x=n.x);"y"in n&&(s.y=n.y);"z"in n&&(s.z=n.z);f.push(s)}if("rx"in n||"ry"in n||"rz"in n)g.push(r.time),s={},"rx"in n&&(s.x=n.rx),"ry"in n&&(s.y=n.ry),"rz"in n&&(s.z=n.rz),k.push(s);if("sx"in n||"sy"in n||"sz"in n)h.push(r.time),s={},"sx"in n&&(s.x=n.sx),"sy"in n&&
(s.y=n.sy),"sz"in n&&(s.z=n.sz),m.push(s)}else"material"==r.type&&("opacity"in n&&(l.push(r.time),p.push({opacity:parseFloat(n.opacity)})),"color"in n&&(q.push(r.time),r=new THREE.Color(n.color),u.push({r:r.r,g:r.g,b:r.b})))}return{duration:a,loop:b,easing:c,poskeys:e,posvalues:f,rotkeys:g,rotvalues:k,sclkeys:h,sclvalues:m,opakeys:l,opavalues:p,colorkeys:q,colorvalues:u}};
...
glam.TransitionElement.parse=function(a,b,c){a=(b.transition||"").split(",");c=a.length;for(b=0;b<c;b++){var d=a[b];if(d){d=d.split(" ");""==d[0]&&d.shift();var e=d[2]||glam.TransitionElement.DEFAULT_TIMING_FUNCTION,f=d[3]||"";glam.AnimationElement.parseTime(d[1]);glam.AnimationElement.parseTimingFunction(e);glam.AnimationElement.parseTime(f)}}};glam.Billboard=function(a){a=a||{};this.enabled=void 0!==a.enabled?a.enabled:glam.Billboard.DEFAULT_ENABLED;this.screenAlign=void 0!==a.screenAlign?a.screenAlign:glam.Billboard.DEFAULT_SCREENALIGN;this.origin=new THREE.Vector3;this.up=new THREE.Vector3(0,1,0);this.z=new THREE.Vector3(0,0,1);this.campos=new THREE.Vector3;this.prevcampos=new THREE.Vector3;this.plane=new THREE.Plane(this.up.clone());this.invMat=new THREE.Matrix4;this.projectedPoint=new THREE.Vector3;glam.Component.call(this,a)};
goog.inherits(glam.Billboard,glam.Component);glam.Billboard.prototype.realize=function(){glam.Component.prototype.realize.call(this)};
glam.Billboard.prototype.update=function(){if(this.enabled){var a=this._object,b=glam.Graphics.instance.camera;this.origin.set(0,0,0);this.origin.applyMatrix4(b.matrixWorld);this.campos.copy(b.position);this.campos.distanceTo(this.prevcampos)>glam.Billboard.EPSILON&&(this.prevcampos.copy(this.campos),this.screenAlign?a.transform.lookAt(this.campos):(this.plane.projectPoint(this.campos,this.projectedPoint),console.log(this.projectedPoint),this.projectedPoint.normalize(),b=Math.acos(this.z.dot(this.projectedPoint)),
console.log("theta",b),this.up.crossVectors(this.projectedPoint,this.z),0>this.up.y&&(this.up.y=1),a.transform.lookAt(this.projectedPoint)))}};glam.Billboard.DEFAULT_ENABLED=!0;glam.Billboard.DEFAULT_SCREENALIGN=!1;glam.Billboard.EPSILON=0.001;glam.GroupElement={};glam.GroupElement.create=function(a,b){return new glam.Object};glam.HighlightBehavior=function(a){a=a||{};this.highlightColor=void 0!==a.highlightColor?a.highlightColor:16777215;this.savedColors=[];glam.Behavior.call(this,a)};goog.inherits(glam.HighlightBehavior,glam.Behavior);glam.HighlightBehavior.prototype.start=function(){glam.Behavior.prototype.start.call(this);if(this._realized&&this._object.visuals){var a=this._object.visuals,b,c=a.length;for(b=0;b<c;b++)this.savedColors.push(a[b].material.color.getHex()),a[b].material.color.setHex(this.highlightColor)}};
...
0;this.orient=this.screenOrientation?THREE.Math.degToRad(this.screenOrientation):0;l.set(this.beta,this.alpha,-this.gamma,"YXZ");b.setFromEuler(l);c.slerp(b,0.5);this.autoAlign?this.orientationQuaternion.copy(b):this.orientationQuaternion.copy(c);this.orientationQuaternion.multiply(q);this.orientationQuaternion.multiply(p.setFromAxisAngle(k,-this.orient));this.object.quaternion.copy(this.alignQuaternion);this.object.quaternion.multiply(this.orientationQuaternion);this.autoForward&&(d.set(0,0,-1).applyQuaternion(this.object.quaternion,
...
l=a.getAttribute("bevelThickness")||glam.TextElement.DEFAULT_BEVEL_THICKNESS,p=a.getAttribute("fontRender")||glam.TextElement.DEFAULT_FONT_RENDER,q=a.getAttribute("width")||glam.TextElement.DEFAULT_WIDTH,u=a.getAttribute("height")||glam.TextElement.DEFAULT_HEIGHT;b&&(b["font-family"]&&(d=b["font-family"]),b["font-weight"]&&(e=b["font-weight"]),b["font-style"]&&(f=b["font-style"]),b["font-size"]&&(g=b["font-size"]),b["font-depth"]&&(k=b["font-depth"]),b["font-bevel"]&&(h=b["font-bevel"]),b["bevel-size"]&&
(m=b["bevel-size"]),b["bevel-thickness"]&&(l=b["bevel-thickness"]),b["font-render"]&&(p=b["font-render"]));d=d.toLowerCase();p=p.toLowerCase();if("polygon"==p)switch(d){case "optima":d="optimer";break;default:d="helvetiker"}THREE.FontUtils.faces[d]||"polygon"!=p||(d="helvetiker");e=e.toLowerCase();"bold"!=e&&"polygon"==p&&(e="normal");f=f.toLowerCase();"polygon"==p&&(f="normal");g=parseFloat(g);k=parseFloat(k);m=parseFloat(m);l=parseFloat(l);h="bevel"==h.toLowerCase()?!0:!1;k||(h=!1);h||(l=m=glam.TextElement.BEVEL_EPSILON,
h=!0);var w=a.getAttribute("value")||glam.TextElement.DEFAULT_VALUE;w||(w=a.textContent);c.value=w;c.fontSize=g;c.fontDepth=k;c.bevelSize=m;c.bevelThickness=l;c.bevelEnabled=h;c.fontFamily=d;c.fontWeight=e;c.fontStyle=f;c.fontRender=p;c.width=q;c.height=u;b&&(c.color=b.color)};glam.TextElement.createVisual=function(a,b,c){return c.value?"polygon"==c.fontRender?glam.TextElement.createPolygonText(a,b,c):"bitmap"==c.fontRender?glam.TextElement.createBitmapText(a,b,c):null:null};
glam.TextElement.createPolygonText=function(a,b,c){a=new THREE.TextGeometry(c.value,{font:c.fontFamily,weight:c.fontWeight,style:c.fontStyle,size:c.fontSize,height:c.fontDepth,curveSegments:4,bevelThickness:c.bevelThickness,bevelSize:c.bevelSize,bevelEnabled:c.bevelEnabled,material:0,extrudeMaterial:1});a.computeBoundingBox();a.computeVertexNormals();c=b.clone();c.shading=THREE.FlatShading;b=b.clone();b.shading=THREE.SmoothShading;b=new THREE.MeshFaceMaterial([c,b]);b=new glam.Visual({geometry:a,
material:b});a.center();return b};glam.TextElement.createBitmapText=function(a,b,c){a=b.clone();a.color.setRGB(1,1,1);a.map=this.createTexture(c);a.transparent=!0;a.depthWrite=!1;return new glam.Visual({geometry:new THREE.PlaneGeometry(c.width,c.height,c.widthSegments,c.heightSegments),material:a})};
glam.TextElement.createTexture=function(a){var b=a.height/a.width,c=document.createElement("canvas");c.width=2048;c.height=2048*b;b=c.getContext("2d");b.fillStyle="rgba(0, 0, 0, 0)";b.fillRect(0,0,c.width,c.height);b.font=a.fontStyle+" "+(144*a.fontSize).toString()+"px "+a.fontFamily;b.fillStyle=a.color;b.fillText(a.value,144,144);a=new THREE.Texture(c);a.needsUpdate=!0;return a};glam.CylinderElement={};glam.CylinderElement.DEFAULT_RADIUS=2;glam.CylinderElement.DEFAULT_HEIGHT=2;glam.CylinderElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.CylinderElement)};glam.CylinderElement.getAttributes=function(a,b,c){var d=a.getAttribute("radius")||glam.CylinderElement.DEFAULT_RADIUS;a=a.getAttribute("height")||glam.CylinderElement.DEFAULT_HEIGHT;b&&(b.radius&&(d=b.radius),b.height&&(a=b.height));d=parseFloat(d);a=parseFloat(a);c.radius=d;c.height=a};
...
glam.ParticlesElement.parseEmitter=function(a,b){var c=parseFloat(a.getAttribute("size")),d=parseFloat(a.getAttribute("sizeEnd")),e=parseInt(a.getAttribute("particlesPerSecond")),f=parseFloat(a.getAttribute("opacityStart")),g=parseFloat(a.getAttribute("opacityMiddle")),k=parseFloat(a.getAttribute("opacityEnd")),h,m,l;if(l=a.getAttribute("colorStart"))h=(new THREE.Color).setStyle(l);if(l=a.getAttribute("colorEnd"))m=(new THREE.Color).setStyle(l);l=parseFloat(a.getAttribute("vx"))||0;var p=parseFloat(a.getAttribute("vy"))||
0,q=parseFloat(a.getAttribute("vz"))||0,u=parseFloat(a.getAttribute("ax"))||0,w=parseFloat(a.getAttribute("ay"))||0,y=parseFloat(a.getAttribute("az"))||0,r=parseFloat(a.getAttribute("psx"))||0,n=parseFloat(a.getAttribute("psy"))||0,s=parseFloat(a.getAttribute("psz"))||0,x=parseFloat(a.getAttribute("asx"))||0,t=parseFloat(a.getAttribute("asy"))||0,B=parseFloat(a.getAttribute("asz"))||0;l=new THREE.Vector3(l,p,q);u=new THREE.Vector3(u,w,y);r=new THREE.Vector3(r,n,s);x=new THREE.Vector3(x,t,B);(t=a.getAttribute("velocity"))&&
glam.DOMTypes.parseVector3(t,l);(t=a.getAttribute("acceleration"))&&glam.DOMTypes.parseVector3(t,u);(t=a.getAttribute("positionSpread"))&&glam.DOMTypes.parseVector3(t,r);(t=a.getAttribute("accelerationSpread"))&&glam.DOMTypes.parseVector3(t,x);t=THREE.NoBlending;switch((a.getAttribute("blending")||"").toLowerCase()){case "normal":t=THREE.NormalBlending;break;case "additive":t=THREE.AdditiveBlending;break;case "subtractive":t=THREE.SubtractiveBlending;break;case "multiply":t=THREE.MultiplyBlending;
break;case "custom":t=THREE.CustomBlending}b.size=c;b.sizeEnd=d;void 0!==h&&(b.colorStart=h);void 0!==m&&(b.colorEnd=m);b.particlesPerSecond=e;b.opacityStart=f;b.opacityMiddle=g;b.opacityEnd=k;b.velocity=l;b.acceleration=u;b.positionSpread=r;b.accelerationSpread=x;b.blending=t};glam.ParticlesElement.addEmitters=function(a,b){var c,d=a.length;for(c=0;c<d;c++)b.addComponent(a[c])};glam.ParticlesElement.DEFAULT_MAX_AGE=1;glam.BackgroundElement={};glam.BackgroundElement.DEFAULT_BACKGROUND_TYPE="box";
...
b.camera=e;e.active=!0;c.controllerScript&&(c.controllerScript.enabled=!1);c.controller=a;c.controllerScript=b}else"rift"==d?(a=glam.Prefabs.RiftController({active:!0,headlight:b,mouseLook:!1,useVRJS:!0}),b=a.getComponent(glam.RiftControllerScript),c.addObject(a),d=new glam.Object,e=new glam.PerspectiveCamera,d.addComponent(e),c.addObject(d),b.camera=e,e.active=!0,c.controllerScript&&(c.controllerScript.enabled=!1),c.controller=a,c.controllerScript=b):"deviceorientation"==d&&(a=glam.Prefabs.DeviceOrientationController({active:!0,
headlight:b,mouseLook:!1,useVRJS:!0}),b=a.getComponent(glam.DeviceOrientationControllerScript),c.addObject(a),d=new glam.Object,e=new glam.PerspectiveCamera,d.addComponent(e),c.addObject(d),b.camera=e,e.active=!0,c.controllerScript&&(c.controllerScript.enabled=!1),c.controller=a,c.controllerScript=b);return null};glam.DOMTypes={};
...
transform:!0,animation:!0,visual:!0},light:{cls:glam.LightElement,transform:!0,animation:!0},particles:{cls:glam.ParticlesElement,transform:!0,animation:!0},effect:{cls:glam.EffectElement},surface:{cls:glam.SurfaceElement,transform:!0,animation:!0,input:!0,visual:!0}};glam.DOMTypes.parseVector3Array=function(a,b){var c=a.textContent.match(/\S+/g);if(c){var d,e=c.length;if(!(3>e))for(d=0;d<e;d+=3){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),k=parseFloat(c[d+2]),f=new THREE.Vector3(f,g,k);b.push(f)}}};
...
this.userZoom=!0;this.userZoomSpeed=1;this.userRotate=!0;this.userRotateSpeed=1;this.userPan=!0;this.userPanSpeed=2;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.minDistance=0;this.maxDistance=Infinity;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.usekeys=this.oneButton=!1;var l=this,p=1800,q=new THREE.Vector2,u=new THREE.Vector2,w=new THREE.Vector2,y=new THREE.Vector2,r=new THREE.Vector2,n=new THREE.Vector2,s=0,x=0,t=1,B=new THREE.Vector3,z={NONE:-1,
ROTATE:0,ZOOM:1,PAN:2},A=z.NONE,C={type:"change"};this.rotateLeft=function(a){void 0===a&&(a=c());x-=a};this.rotateRight=function(a){void 0===a&&(a=c());x+=a};this.rotateUp=function(a){void 0===a&&(a=c());s-=a};this.rotateDown=function(a){void 0===a&&(a=c());s+=a};this.zoomIn=function(a){void 0===a&&(a=Math.pow(1/0.95,l.userZoomSpeed));t/=a};this.zoomOut=function(a){void 0===a&&(a=Math.pow(1/0.95,l.userZoomSpeed));t*=a};this.pan=function(a){a.transformDirection(this.object.matrix);a.multiplyScalar(l.userPanSpeed);
this.object.position.add(a);this.center.add(a)};this.update=function(){if(!1!==this.enabled){var a=this.object.position,b=a.clone().sub(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&this.rotateLeft(c());var d=d+x,e=e+s,e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),f=b.length()*t,f=Math.max(this.minDistance,Math.min(this.maxDistance,f));b.x=f*Math.sin(e)*Math.sin(d);b.y=f*Math.cos(e);b.z=f*
Math.sin(e)*Math.cos(d);a.copy(this.center).add(b);this.object.lookAt(this.center);s=x=0;t=1;0<B.distanceTo(this.object.position)&&(this.dispatchEvent(C),B.copy(this.object.position))}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",d,!1);this.domElement.addEventListener("touchstart",function(a){1<a.touches.length?(l.touchDistance=g(a.touches[0],a.touches[1]),l.touchId0=a.touches[0].identifier,l.touchId1=a.touches[1].identifier):
...
c=new THREE.Line(c,a,THREE.LineSegments);c.visible=this.showGrid;this.grid=new glam.Visual({object:c});this.gridRoot.addComponent(this.grid);this.gridPicker=new glam.Picker;var e=this;this.gridPicker.addEventListener("mouseup",function(a){e.highlightObject(null)});this.gridRoot.addComponent(this.gridPicker)};
...
glam.Viewer.GRID_OPACITY=0.2;glam.Viewer.DEFAULT_HEADLIGHT_INTENSITY=1;glam.OculusRiftControls=function(a){var b=this,c=!1,d=!1,e=!1,f=!1,g=!1,k=!1,h=new THREE.Vector3;this.moveSpeed=0.03;this.jumpSpeed=2;var m=new THREE.Quaternion,l=new THREE.Vector3(1,0,0),p=new THREE.Vector3(0,0,1),q=function(a){switch(a.keyCode){case 38:case 87:c=!0;break;case 37:case 65:e=!0;break;case 40:case 83:d=!0;break;case 39:case 68:f=!0;break;case 32:!0===k&&(h.y+=this.jumpSpeed),k=!1}}.bind(this);document.addEventListener("mousemove",function(c){if(!1!==b.enabled){var d=c.movementX||c.mozMovementX||
c.webkitMovementX||0;c=c.movementY||c.mozMovementY||c.webkitMovementY||0;console.log(d,c);m.setFromAxisAngle(p,0.002*d);a.quaternion.multiplySelf(m);m.setFromAxisAngle(l,0.002*c);a.quaternion.multiplySelf(m)}},!1);document.addEventListener("keydown",q,!1);document.addEventListener("keyup",function(a){switch(a.keyCode){case 38:case 87:c=!1;break;case 37:case 65:e=!1;break;case 40:case 83:d=!1;break;case 39:case 68:f=!1}},!1);this.enabled=!1;this.getObject=function(){return a};this.isOnObject=function(a){k=
...
glam.SkysphereScript.prototype.realize=function(){this.material=this._object.getComponent(glam.Visual).material;this.camera=glam.Graphics.instance.backgroundLayer.camera;this.camera.far=2E4;this.camera.position.set(0,0,0)};glam.SkysphereScript.prototype.update=function(){var a=glam.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};glam.System={log:function(){var a=["[glam] "].concat([].slice.call(arguments));console.log.apply(console,a)},info:function(){if(glam.System.logLevel<=glam.System.LOG_INFO){var a=["[glam] "].concat([].slice.call(arguments));console.info.apply(console,a)}},warn:function(){if(glam.System.logLevel<=glam.System.LOG_WARNINGS){var a=["[glam] "].concat([].slice.call(arguments));console.warn.apply(console,a)}},error:function(){if(glam.System.logLevel<=glam.System.LOG_ERRORS){var a=["[glam] "].concat([].slice.call(arguments));
console.error.apply(console,a)}},ajax:function(a){var b=a.dataType,c=a.success,d=a.error,e=new XMLHttpRequest;e.open(a.type,a.url,!0);e.responseType=b;e.addEventListener("load",function(a){c(e.response)},!1);e.addEventListener("error",function(a){d(e.status)},!1);e.send(null)}};glam.System.LOG_INFO=0;glam.System.LOG_WARNINGS=1;glam.System.LOG_ERRORS=2;glam.System.logLevel=glam.System.LOG_INFO;glam.PointLight=function(a){a=a||{};glam.Light.call(this,a);this.positionVec=new THREE.Vector3;this.object=a.object?a.object:new THREE.PointLight(a.color,a.intensity,void 0!==a.distance?a.distance:glam.PointLight.DEFAULT_DISTANCE);Object.defineProperties(this,{distance:{get:function(){return this.object.distance},set:function(a){this.object.distance=a}}})};goog.inherits(glam.PointLight,glam.Light);glam.PointLight.prototype.realize=function(){glam.Light.prototype.realize.call(this)};
...
this.mouseY=a.pageY-this.domElement.offsetTop-this.viewHalfY)};this.onTouchStart=function(a){a.preventDefault();0<a.touches.length&&(-1==this.lookTouchId?(this.lookTouchId=a.touches[0].identifier,this.onMouseDown({type:"mousedown",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.touches[0].screenX,screenY:a.touches[0].screenY,clientX:a.touches[0].clientX,clientY:a.touches[0].clientY,pageX:a.touches[0].pageX,pageY:a.touches[0].pageY,button:0,preventDefault:a.preventDefault})):
(this.touchScreenX=a.touches[1].screenX,this.touchScreenY=a.touches[1].screenY,this.moveTouchId=a.touches[1].identifier))};this.onTouchMove=function(a){a.preventDefault();for(var b=null,c=null,d=a.changedTouches.length,h=0;h<d;h++)a.changedTouches[h].identifier==this.lookTouchId&&(b=a.changedTouches[h]),a.changedTouches[h].identifier==this.moveTouchId&&(c=a.changedTouches[h]);if(b)this.onMouseMove({type:"mousemove",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:b.screenX,
screenY:b.screenY,clientX:b.clientX,clientY:b.clientY,pageX:b.pageX,pageY:b.pageY,button:0,preventDefault:a.preventDefault});c&&(a=c.screenX-this.touchScreenX,b=c.screenY-this.touchScreenY,this.touchScreenX=c.screenX,this.touchScreenY=c.screenY,0<a&&(this.moveRight=!0),0>a&&(this.moveLeft=!0),0<b&&(this.moveBackward=!0),0>b&&(this.moveForward=!0))};this.onTouchEnd=function(a){a.preventDefault();for(var b=null,c=null,d=a.changedTouches.length,h=0;h<d;h++)a.changedTouches[h].identifier==this.lookTouchId&&
(b=a.changedTouches[h]),a.changedTouches[h].identifier==this.moveTouchId&&(c=a.changedTouches[h]);b&&(this.onMouseUp({type:"mouseup",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:b.screenX,screenY:b.screenY,clientX:b.clientX,clientY:b.clientY,pageX:b.pageX,pageY:b.pageY,button:0,preventDefault:a.preventDefault}),this.lookTouchId=-1);c&&(this.touchScreenX=c.screenX,this.touchScreenY=c.screenY,this.moveForward=this.moveBackward=this.moveLeft=this.moveRight=!1,this.moveTouchId=
-1)};this.onGamepadButtonsChanged=function(a){};this.onGamepadAxesChanged=function(a){a=a.changedAxes;var b,c=a.length;for(b=0;b<c;b++){var d=a[b];d.axis==glam.Gamepad.AXIS_LEFT_V?-0.2>d.value?(this.moveForward=!0,this.moveBackward=!1):(this.moveBackward=0.2<d.value?!0:!1,this.moveForward=!1):d.axis==glam.Gamepad.AXIS_LEFT_H?0.5<d.value?(this.moveRight=!0,this.moveLeft=!1):(this.moveLeft=-0.5>d.value?!0:!1,this.moveRight=!1):d.axis==glam.Gamepad.AXIS_RIGHT_V?-0.2>d.value?(this.tiltUp=!0,this.tiltDown=
!1):(this.tiltDown=0.2<d.value?!0:!1,this.tiltUp=!1):d.axis==glam.Gamepad.AXIS_RIGHT_H&&(0.5<d.value?(this.turnLeft=!0,this.turnRight=!1):-0.5>d.value?(this.turnRight=!0,this.turnLeft=!1):this.turnRight=this.turnLeft=!1)}};this.onKeyDown=function(a){this.useWASD&&(87==a.keyCode&&(this.moveForward=!0),65==a.keyCode&&(this.moveLeft=!0),83==a.keyCode&&(this.moveBackward=!0),68==a.keyCode&&(this.moveRight=!0),82==a.keyCode&&(this.moveUp=!0),70==a.keyCode&&(this.moveDown=!0));this.useArrows&&(38==a.keyCode&&
(this.moveForward=!0),37==a.keyCode&&(this.moveLeft=!0),40==a.keyCode&&(this.moveBackward=!0),39==a.keyCode&&(this.moveRight=!0))};this.onKeyUp=function(a){this.useWASD&&(87==a.keyCode&&(this.moveForward=!1),65==a.keyCode&&(this.moveLeft=!1),83==a.keyCode&&(this.moveBackward=!1),68==a.keyCode&&(this.moveRight=!1),82==a.keyCode&&(this.moveUp=!1),70==a.keyCode&&(this.moveDown=!1));this.useArrows&&(38==a.keyCode&&(this.moveForward=!1),37==a.keyCode&&(this.moveLeft=!1),40==a.keyCode&&(this.moveBackward=
!1),39==a.keyCode&&(this.moveRight=!1))};this.update=function(a){if(!1!==this.enabled){this.startY=this.object.position.y;a*=this.movementSpeed;this.moveForward&&this.object.translateZ(-a);this.moveBackward&&this.object.translateZ(a);this.moveLeft&&this.object.translateX(-a);this.moveRight&&this.object.translateX(a);this.object.position.y=this.startY;if((this.mouseDragOn||this.mouseLook)&&this.lookSpeed){a=this.lastMouseX-this.mouseX;Math.abs(a);a=900*(a/this.viewHalfX);this.lon+=a*this.lookSpeed;
a=this.lastMouseY-this.mouseY;Math.abs(a);a=900*(a/this.viewHalfY);this.lat+=a*this.lookSpeed;this.theta=THREE.Math.degToRad(this.lon);this.lat=Math.max(-85,Math.min(85,this.lat));this.phi=THREE.Math.degToRad(this.lat);a=this.target;var b=this.object.position;a.x=b.x-Math.sin(this.theta);a.y=b.y+Math.sin(this.phi);a.z=b.z-Math.cos(this.theta);this.object.lookAt(a);this.lastMouseX=this.mouseX;this.lastMouseY=this.mouseY}if(this.turnRight||this.turnLeft||this.tiltUp||this.tiltDown)a=0,this.turnRight?
a=1:this.turnLeft&&(a=-1),this.lon+=a*this.turnSpeed,a=0,this.tiltUp?a=1:this.tiltDown&&(a=-1),this.lat+=a*this.tiltSpeed,this.theta=THREE.Math.degToRad(this.lon),this.lat=Math.max(-85,Math.min(85,this.lat)),this.phi=THREE.Math.degToRad(this.lat),a=this.target,b=this.object.position,this.turnSpeed&&(a.x=b.x-Math.sin(this.theta)),this.tiltSpeed&&(a.y=b.y+Math.sin(this.phi),a.z=b.z-Math.cos(this.theta)),(this.turnSpeed||this.tiltSpeed)&&this.object.lookAt(a)}};this.domElement.addEventListener("contextmenu",
...
glam.setFullScreen=function(a){return glam.Graphics.instance.setFullScreen(a)};glam.createElement=function(a){return glam.DOM.createElement(a)};
