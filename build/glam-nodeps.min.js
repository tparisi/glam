...
!b[a].object.visible;)a++;var c=b[a]}if(c&&c.object){a=glam.ViewPicker.findObjectFromIntersected(c.object);if(a.viewpickers){var b=a.viewpickers,d=b.length;for(a=0;a<d;a++)if(b[a].enabled)return b[a]}return glam.ViewPicker.findObjectPicker(c.object)}return null};glam.ViewPicker.findObjectFromIntersected=function(a){return a.data?a.data:a.parent?glam.ViewPicker.findObjectFromIntersected(a.parent):null};
