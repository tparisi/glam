...
(this.riftCam=new THREE.VREffect(this.renderer,function(a){a&&glam.System.warn("Unable to create VR renderer: ",a)}));a.cardboard&&(this.cardboard=new THREE.StereoEffect(this.renderer),this.cardboard.setSize(this.container.offsetWidth,this.container.offsetHeight));this.composer=null};
