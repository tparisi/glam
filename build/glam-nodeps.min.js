...
transform:!0,animation:!0,visual:!0},light:{cls:glam.LightElement,transform:!0,animation:!0},particles:{cls:glam.ParticlesElement,transform:!0,animation:!0},effect:{cls:glam.EffectElement}};glam.DOMTypes.parseVector3Array=function(a,b){var c=a.textContent.match(/\S+/g),d,e=c.length;if(!(3>e))for(d=0;d<e;d+=3){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),l=parseFloat(c[d+2]),f=new THREE.Vector3(f,g,l);b.push(f)}};
glam.DOMTypes.parseVector3=function(a,b){var c=a.match(/\S+/g);if(!(3>c.length)){var d=parseFloat(c[0]),e=parseFloat(c[1]),c=parseFloat(c[2]);b.set(d,e,c)}};glam.DOMTypes.parseVector2Array=function(a,b){var c=a.textContent.match(/\S+/g),d,e=c.length;if(!(2>e))for(d=0;d<e;d+=2){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),f=new THREE.Vector2(f,g);b.push(f)}};
glam.DOMTypes.parseColor3Array=function(a,b){var c=a.textContent.match(/\S+/g),d,e=c.length;if(!(3>e))for(d=0;d<e;d+=3){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),l=parseFloat(c[d+2]),f=new THREE.Color(f,g,l);b.push(f)}};glam.DOMTypes.parseColor3=function(a,b){var c=a.match(/\S+/g);if(!(3>c.length)){var d=parseFloat(c[0]),e=parseFloat(c[1]),c=parseFloat(c[2]);b.setRGB(d,e,c)}};
glam.DOMTypes.parseFaceArray=function(a,b){var c=a.textContent.match(/\S+/g),d,e=c.length;if(!(1>e))for(d=0;d<e;d+=3){var f=parseInt(c[d]),g=parseInt(c[d+1]),l=parseInt(c[d+2]),f=new THREE.Face3(f,g,l);b.push(f)}};glam.DOMTypes.parseUVArray=function(a,b){var c=a.textContent.match(/\S+/g),d,e=c.length;if(!(6>e))for(d=0;d<e;d+=6){for(var f=[],g=0;3>g;g++){var l=parseFloat(c[d+2*g]),h=parseFloat(c[d+2*g+1]),l=new THREE.Vector2(l,h);f.push(l)}b.push(f)}};glam.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*k.autoRotateSpeed}function d(a){!1!==k.enabled&&!1!==k.userRotate&&(a.preventDefault(),0===a.button||k.oneButton&&2===a.button?(A=z.ROTATE,p.set(a.clientX,a.clientY)):1===a.button&&k.userZoom?(A=z.ZOOM,x.set(a.clientX,a.clientY)):2===a.button&&k.userPan&&(A=z.PAN),k.domElement.addEventListener("mousemove",e,!1),k.domElement.addEventListener("mouseup",l,!1),k.domElement.addEventListener("touchmove",f,!1),k.domElement.addEventListener("touchend",
