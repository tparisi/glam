...
if(6==b.length)return console.log("**** GLAM: Loading cubemap",b[0]),THREE.ImageUtils.loadTextureCube(b,THREE.Texture.DEFAULT_MAPPING,function(a){console.log("**** GLAM: cubemap loaded",a,b[0])});if(a["sphere-image"]){var c=glam.DOMMaterial.parseUrl(a["sphere-image"]);console.log("**** GLAM: Loading spheremap",c);return THREE.ImageUtils.loadTexture(c,THREE.SphericalRefractionMapping,function(a){console.log("**** GLAM: spheremap loaded",a,c)})}return null};
