...
console.log("theta",b),this.up.crossVectors(this.projectedPoint,this.z),0>this.up.y&&(this.up.y=1,b=-b),a.transform.rotation.y=-b))}};glam.Billboard.DEFAULT_ENABLED=!0;glam.Billboard.DEFAULT_SCREENALIGN=!0;glam.Billboard.EPSILON=0.001;glam.GroupElement={};glam.GroupElement.create=function(a,b){return new glam.Object};glam.HighlightBehavior=function(a){a=a||{};this.highlightColor=void 0!==a.highlightColor?a.highlightColor:16777215;this.savedColors=[];glam.Behavior.call(this,a)};goog.inherits(glam.HighlightBehavior,glam.Behavior);glam.HighlightBehavior.prototype.start=function(){glam.Behavior.prototype.start.call(this);if(this._realized&&this._object.visuals){var a=this._object.visuals,b,c=a.length;for(b=0;b<c;b++)this.savedColors.push(a[b].material.color.getHex()),a[b].material.color.setHex(this.highlightColor)}};
