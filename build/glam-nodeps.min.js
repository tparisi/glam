...
glam.SkysphereScript.prototype.realize=function(){this.material=this._object.getComponent(glam.Visual).material;this.camera=glam.Graphics.instance.backgroundLayer.camera;this.camera.far=2E4;this.camera.position.set(0,0,0)};glam.SkysphereScript.prototype.update=function(){var a=glam.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};glam.System={log:function(){if(glam.System.logLevel<=glam.System.LOG_INFO){var a=["[glam] "].concat([].slice.call(arguments));console.log.apply(console,a)}},warn:function(){if(glam.System.logLevel<=glam.System.LOG_WARNINGS){var a=["[glam] "].concat([].slice.call(arguments));console.warn.apply(console,a)}},error:function(){if(glam.System.logLevel<=glam.System.LOG_ERRORS){var a=["[glam] "].concat([].slice.call(arguments));console.error.apply(console,a)}},ajax:function(a){var b=a.dataType,c=a.success,
