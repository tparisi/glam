...
glam.SkyboxScript.prototype.realize=function(){this.uniforms=this._object.getComponent(glam.Visual).material.uniforms;this.camera=glam.Graphics.instance.backgroundLayer.camera;this.camera.far=2E4;this.camera.position.set(0,0,0)};glam.SkyboxScript.prototype.update=function(){var a=glam.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};glam.SurfaceElement={};glam.SurfaceElement.DEFAULT_WIDTH=2;glam.SurfaceElement.DEFAULT_HEIGHT=2;glam.SurfaceElement.DEFAULT_WIDTH_SEGMENTS=1;glam.SurfaceElement.DEFAULT_HEIGHT_SEGMENTS=1;glam.SurfaceElement.DEFAULT_CURVATURE=0;glam.SurfaceElement.DEFAULT_VALUE="";glam.SurfaceElement.DEFAULT_COLOR="black";glam.SurfaceElement.DEFAULT_BACKGROUND_COLOR="white";glam.SurfaceElement.DEFAULT_FONT_FAMILY="helvetica";glam.SurfaceElement.DEFAULT_FONT_WEIGHT="normal";glam.SurfaceElement.DEFAULT_FONT_STYLE="normal";
glam.SurfaceElement.DEFAULT_FONT_SIZE=10;glam.SurfaceElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.SurfaceElement)};
...
glam.SurfaceElement.createTexture=function(a){var b=a.height/a.width,c=document.createElement("canvas");c.width=2048;c.height=2048*b;b=c.getContext("2d");b.fillStyle="rgba(0, 0, 0, 0)";b.fillRect(0,0,c.width,c.height);b.fillStyle=a.backgroundColor;b.strokeStyle=a.color;b.lineWidth=a.border;glam.SurfaceElement.roundRect(b,0,0,c.width,c.height,{left:a.borderRadiusLeft,right:a.borderRadiusRight,top:a.borderRadiusTop,bottom:a.borderRadiusBottom},!0,a.border);b.font=a.fontStyle+" "+(1*a.fontSize).toString()+
"px "+a.fontFamily;b.fillStyle=a.color;b.fillText(a.value,50,200);a=new THREE.Texture(c);a.needsUpdate=!0;return a};
