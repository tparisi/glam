...
glam.PerspectiveCamera.prototype.update=function(){this.updateProjection&&(this.object.updateProjectionMatrix(),this.updateProjection=!1)};glam.PointerLockControls=function(a){var b=this;this.speed=0.05;this.speedMultiplier=1;this.fly=!1;this.jumpPower=0.1;this.gravity=0;a.rotation.set(0,0,0);var c=new THREE.Object3D;c.add(a);var d=new THREE.Object3D;d.position.y=10;d.add(c);var e=!1,f=!1,g=!1,l=!1,h=new THREE.Vector3,m=Math.PI/2;document.addEventListener("mousemove",function(a){if(!1!==b.enabled){var e=a.movementY||a.mozMovementY||a.webkitMovementY||0;d.rotation.y-=0.002*(a.movementX||a.mozMovementX||a.webkitMovementX||0);c.rotation.x-=
0.002*e;c.rotation.x=Math.max(-m,Math.min(m,c.rotation.x))}},!1);document.addEventListener("keydown",function(a){switch(a.keyCode){case 16:this.speedMultiplier=10;break;case 17:this.speedMultiplier=0.5;break;case 38:case 87:e=!0;break;case 37:case 65:g=!0;break;case 40:case 83:f=!0;break;case 39:case 68:l=!0;break;case 67:h.y+=this.jumpPower;break;case 32:h.y-=this.jumpPower}}.bind(this),!1);document.addEventListener("keyup",function(a){switch(a.keyCode){case 16:this.speedMultiplier=1;break;case 17:this.speedMultiplier=
1;break;case 38:case 87:e=!1;break;case 37:case 65:g=!1;break;case 40:case 83:f=!1;break;case 39:case 68:l=!1;break;case 32:h.y=0;break;case 67:h.y=0}}.bind(this),!1);this.enabled=!1;this.getObject=function(){return d};this.getPosition=function(){return(new THREE.Vector3).copy(d.position)};this.getDirection=function(){var a=new THREE.Vector3(0,0,-1),b=new THREE.Euler(0,0,0,"YXZ");return function(){v=new THREE.Vector3;b.set(c.rotation.x,d.rotation.y,0);v.copy(a).applyEuler(b);return v}}();this.update=
function(a){!1!==b.enabled&&(a*=0.1,h.x+=0.08*-h.x*a,h.z+=0.08*-h.z*a,h.y-=this.gravity*a,e&&(h.z-=this.speed*a*this.speedMultiplier),f&&(h.z+=this.speed*a*this.speedMultiplier),g&&(h.x-=this.speed*a*this.speedMultiplier),l&&(h.x+=this.speed*a*this.speedMultiplier),d.translateX(h.x),d.translateY(h.y),d.translateZ(h.z),10>d.position.y&&(h.y=0,d.position.y=10))}};glam.VisualElement={};glam.VisualElement.create=function(a,b,c){var d={};c.getAttributes(a,b,d);var e=new glam.Object;(b=glam.DOMMaterial.create(b,function(b){glam.VisualElement.createVisual(e,c,a,b,d)}))&&glam.VisualElement.createVisual(e,c,a,b,d);return e};glam.VisualElement.createVisual=function(a,b,c,d,e){if(b=b.createVisual(c,d,e))a.addComponent(b),glam.VisualElement.addProperties(c,a)};
...
glam.DOMViewer.prototype.traverse=function(a,b){var c=a.tagName,d,e,f=a.childNodes;e=f.length;for(d=0;d<e;d++){var g=f[d];(c=g.tagName)&&(c=c.toLowerCase());var l=null;if((c=c?glam.DOMTypes.types[c]:null)&&c.cls&&(l=c.cls.create)&&"function"==typeof l){glam.DOMElement.init(g);var h=glam.DOMElement.getStyle(g);if(l=l.call(this,g,h,this.app))g.glam.object=l,this.addFeatures(g,h,l,c),b.addChild(l),this.traverse(g,l)}}};
...
glam.ParticleEmitter.DEFAULT_OPACITY_MIDDLE,l=this.param.opacityEnd||glam.ParticleEmitter.DEFAULT_OPACITY_END,h=this.param.velocity||glam.ParticleEmitter.DEFAULT_VELOCITY,m=this.param.acceleration||glam.ParticleEmitter.DEFAULT_ACCELERATION,k=this.param.positionSpread||glam.ParticleEmitter.DEFAULT_POSITION_SPREAD,t=this.param.accelerationSpread||glam.ParticleEmitter.DEFAULT_ACCELERATION_SPREAD,p=this.param.blending||glam.ParticleEmitter.DEFAULT_BLENDING;this._active=!1;this.object=new ShaderParticleEmitter({size:a,
sizeEnd:b,colorStart:c,colorEnd:d,particlesPerSecond:e,opacityStart:f,opacityMiddle:g,opacityEnd:l,velocity:h,acceleration:m,positionSpread:k,accelerationSpread:t,blending:p});Object.defineProperties(this,{active:{get:function(){return this._active},set:function(a){this.setActive(a)}}})};goog.inherits(glam.ParticleEmitter,glam.Component);glam.ParticleEmitter.prototype.realize=function(){};glam.ParticleEmitter.prototype.update=function(){};
...
glam.DOMMaterial.parseStyle=function(a){var b="";a.image&&(b=glam.DOMMaterial.parseUrl(a.image));var c="";a["normal-image"]&&(c=glam.DOMMaterial.parseUrl(a["normal-image"]));var d="";a["bump-image"]&&(d=glam.DOMMaterial.parseUrl(a["bump-image"]));var e="";a["specular-image"]&&(e=glam.DOMMaterial.parseUrl(a["specular-image"]));var f;a.reflectivity&&(f=parseFloat(a.reflectivity));var g;a.refractionRatio&&(g=parseFloat(a.refractionRatio));var l=glam.DOMMaterial.tryParseEnvMap(a),h,m,k,t,p="";if(p=a.color)h=
(new THREE.Color).setStyle(p).getHex();if(p=a["diffuse-color"])m=(new THREE.Color).setStyle(p).getHex();if(p=a["specular-color"])k=(new THREE.Color).setStyle(p).getHex();if(p=a["ambient-color"])t=(new THREE.Color).setStyle(p).getHex();var u;a.opacity&&(u=parseFloat(a.opacity));p=THREE.FrontSide;if(a["backface-visibility"])switch(a["backface-visibility"].toLowerCase()){case "visible":p=THREE.DoubleSide;break;case "hidden":p=THREE.FrontSide}var w;a.hasOwnProperty("render-mode")&&(w="wireframe"==a["render-mode"]);
var x;a["line-width"]&&(x=parseInt(a["line-width"]));var q;a["dash-size"]&&(q=parseInt(a["dash-size"]));var n;a["gap-size"]&&(n=parseInt(a["gap-size"]));a={};b&&(a.map=THREE.ImageUtils.loadTexture(b));l&&(a.envMap=l);c&&(a.normalMap=THREE.ImageUtils.loadTexture(c));d&&(a.bumpMap=THREE.ImageUtils.loadTexture(d));e&&(a.specularMap=THREE.ImageUtils.loadTexture(e));void 0!==h&&(a.color=h);void 0!==m&&(a.color=m);void 0!==k&&(a.specular=k);void 0!==t&&(a.ambient=t);void 0!==u&&(a.opacity=u,a.transparent=
1>u);void 0!==w&&(a.wireframe=w);void 0!==x&&(a.linewidth=x);void 0!==q&&(a.dashSize=q);void 0!==n&&(a.gapSize=n);void 0!==f&&(a.reflectivity=f);void 0!==g&&(a.refractionRatio=g);a.side=p;return a};glam.DOMMaterial.parseUrl=function(a){return a=/\(([^)]+)\)/.exec(a)[1]};
...
return 6==b.length?THREE.ImageUtils.loadTextureCube(b):a["sphere-image"]?THREE.ImageUtils.loadTexture(glam.DOMMaterial.parseUrl(a["sphere-image"]),THREE.SphericalRefractionMapping):null};
glam.DOMMaterial.createShaderMaterial=function(a,b,c){function d(){var a=new THREE.ShaderMaterial({vertexShader:m,fragmentShader:k,uniforms:g});glam.DOMMaterial.saveShaderMaterial(l,h,a);glam.DOMMaterial.callShaderMaterialCallbacks(l,h)}var e=a["vertex-shader"],f=a["fragment-shader"],g=glam.DOMMaterial.parseUniforms(a["shader-uniforms"],b),l=glam.DOMMaterial.parseUrl(e),h=glam.DOMMaterial.parseUrl(f);if(!l||!h){var m=document.getElementById(e).textContent,k=document.getElementById(f).textContent;
return m&&k?new THREE.ShaderMaterial({vertexShader:m,fragmentShader:k,uniforms:g}):null}if(a=glam.DOMMaterial.getShaderMaterial(l,h))return a;glam.DOMMaterial.addShaderMaterialCallback(l,h,c);glam.DOMMaterial.getShaderMaterialLoading(l,h)||(glam.DOMMaterial.setShaderMaterialLoading(l,h),k=m="",$.ajax({type:"GET",url:l,dataType:"text",success:function(a){m=a;k&&d()}}),$.ajax({type:"GET",url:h,dataType:"text",success:function(a){k=a;m&&d()}}))};
glam.DOMMaterial.parseUniforms=function(a,b){var c={},d=a.split(" "),e,f=d.length/3;for(e=0;e<f;e++){var g=d[3*e],l=d[3*e+1],h=d[3*e+2];"f"==l&&(h=parseFloat(h));if("c"==l){var m=new THREE.Color;m.setStyle(h);h=m}else"t"==l&&(h=h.toLowerCase(),"cube"==h?h=b.envMap:(h=glam.DOMMaterial.parseUrl(h),h=THREE.ImageUtils.loadTexture(h),h.wrapS=h.wrapT=THREE.Repeat));c[g]={type:l,value:h}}return c};glam.DOMMaterial.shaderMaterials={};
...
glam.MeshElement.parse=function(a,b,c,d){var e=a.getElementsByTagName("vertices");e&&(e=e[0])&&glam.DOMTypes.parseVector3Array(e,b.vertices);(e=a.getElementsByTagName("uvs"))&&(e=e[0])&&glam.DOMTypes.parseUVArray(e,b.faceVertexUvs[0]);(e=a.getElementsByTagName("faces"))&&(e=e[0])&&glam.DOMTypes.parseFaceArray(e,b.faces);var f=[];if(e=a.getElementsByTagName("normals"))if(e=e[0])if(glam.DOMTypes.parseVector3Array(e,f),d.vertexNormals)for(var g=b.faces.length,e=0;e<g;e++){var l=b.faces[e];if(l){var h=
f[l.a].normalize().clone();l.vertexNormals[0]=h;h=f[l.b].normalize().clone();l.vertexNormals[1]=h;h=f[l.c].normalize().clone();l.vertexNormals[2]=h}}else for(g=b.faces.length,e=0;e<g;e++)if(l=b.faces[e])h=f[e].normalize(),l.normal.copy(h);f=[];if(a=a.getElementsByTagName("colors"))if(a=a[0]){glam.DOMTypes.parseColor3Array(a,f);if(d.vertexColors){g=b.faces.length;for(e=0;e<g;e++)if(l=b.faces[e])(d=f[l.a])&&(l.vertexColors[0]=d.clone()),(d=f[l.b])&&(l.vertexColors[1]=d.clone()),(d=f[l.c])&&(l.vertexColors[2]=
d.clone());c.vertexColors=THREE.VertexColors}else{g=b.faces.length;for(e=0;e<g;e++)(l=b.faces[e])&&(d=f[e])&&l.color.copy(d);c.vertexColors=THREE.FaceColors}b.colorsNeedUpdate=!0;b.buffersNeedUpdate=!0}};glam.Gamepad=function(){glam.EventDispatcher.call(this);this.controllers={};this.values={};glam.Gamepad.instance=this};goog.inherits(glam.Gamepad,glam.EventDispatcher);glam.Gamepad.prototype.update=function(){this.scanGamepads();var a={changedButtons:[]},b={changedAxes:[]},c;for(c in this.controllers){var d=this.controllers[c];this.testValues(d,a,b);this.saveValues(d)}a.changedButtons.length&&this.dispatchEvent("buttonsChanged",a);b.changedAxes.length&&this.dispatchEvent("axesChanged",b)};
...
b.split("\\s+"),a=f[0],d=f[1],e=f[2],f=f[4];d=d||glam.AnimationElement.DEFAULT_DURATION;d=glam.AnimationElement.parseTime(d);e=e||glam.AnimationElement.DEFAULT_TIMING_FUNCTION;e=glam.AnimationElement.parseTimingFunction(e);f=f||glam.AnimationElement.DEFAULT_ITERATION_COUNT;f="infinite"==f.toLowerCase()?!0:!1;if(a){a=glam.DOM.getStyle(a);b=[];for(var g in a){var l;l="from"==g?0:"to"==g?1:glam.AnimationElement.parseFrameTime(g);var h,m=a[g],k;for(k in m){var t=m[k],p;if("transform"==k||"-webkit-transform"==
k||"-moz-transform"==k)p="transform",h={},glam.DOMTransform.parseTransform(t,h);else if("opacity"==k||"color"==k)p="material",h=glam.DOMMaterial.parseStyle(m);b.push({time:l,value:h,type:p})}}d=glam.AnimationElement.build(d,f,e,b);glam.AnimationElement.addAnimationToObject(d,c)}};
glam.AnimationElement.build=function(a,b,c,d){var e=[],f=[],g=[],l=[],h=[],m=[],k=[],t=[],p=[],u=[],w,x=d.length;for(w=0;w<x;w++){var q=d[w],n=q.value;if("transform"==q.type){if("x"in n||"y"in n||"z"in n){e.push(q.time);var r={};"x"in n&&(r.x=n.x);"y"in n&&(r.y=n.y);"z"in n&&(r.z=n.z);f.push(r)}if("rx"in n||"ry"in n||"rz"in n)g.push(q.time),r={},"rx"in n&&(r.x=n.rx),"ry"in n&&(r.y=n.ry),"rz"in n&&(r.z=n.rz),l.push(r);if("sx"in n||"sy"in n||"sz"in n)h.push(q.time),r={},"sx"in n&&(r.x=n.sx),"sy"in n&&
(r.y=n.sy),"sz"in n&&(r.z=n.sz),m.push(r)}else"material"==q.type&&("opacity"in n&&(k.push(q.time),t.push({opacity:parseFloat(n.opacity)})),"color"in n&&(p.push(q.time),q=new THREE.Color(n.color),u.push({r:q.r,g:q.g,b:q.b})))}return{duration:a,loop:b,easing:c,poskeys:e,posvalues:f,rotkeys:g,rotvalues:l,sclkeys:h,sclvalues:m,opakeys:k,opavalues:t,colorkeys:p,colorvalues:u}};
...
glam.LightElement.create=function(a,b,c){c=a.getAttribute("type")||glam.LightElement.DEFAULT_TYPE;var d=a.getAttribute("color")||glam.LightElement.DEFAULT_COLOR,e=a.getAttribute("angle")||glam.LightElement.DEFAULT_ANGLE,f=a.getAttribute("distance")||glam.LightElement.DEFAULT_DISTANCE,g=a.getAttribute("exponent")||glam.LightElement.DEFAULT_EXPONENT,l=new THREE.Vector3(0,0,-1),h=parseFloat(a.getAttribute("dx"))||0,m=parseFloat(a.getAttribute("dy"))||0;a=parseFloat(a.getAttribute("dz"))||0;(h||m||a)&&
l.set(h,m,a);l.normalize();b&&(b.type&&(c=b.type),b.color&&(d=b.color),b.angle&&(e=b.angle),b.distance&&(f=b.distance));d=(new THREE.Color).setStyle(d).getHex();e=glam.DOMTransform.parseRotation(e);f=parseFloat(f);g=parseFloat(g);b={color:d,angle:e,direction:l,distance:f,exponent:g};a=new glam.Object;d=null;switch(c.toLowerCase()){case "directional":d=new glam.DirectionalLight(b);break;case "point":d=new glam.PointLight(b);break;case "spot":d=new glam.SpotLight(b);break;case "ambient":d=new glam.AmbientLight(b)}return d?
...
0;this.orient=this.screenOrientation?THREE.Math.degToRad(this.screenOrientation):0;k.set(this.beta,this.alpha,-this.gamma,"YXZ");b.setFromEuler(k);c.slerp(b,0.5);this.autoAlign?this.orientationQuaternion.copy(b):this.orientationQuaternion.copy(c);this.orientationQuaternion.multiply(p);this.orientationQuaternion.multiply(t.setFromAxisAngle(l,-this.orient));this.object.quaternion.copy(this.alignQuaternion);this.object.quaternion.multiply(this.orientationQuaternion);this.autoForward&&(d.set(0,0,-1).applyQuaternion(this.object.quaternion,
...
transform:!0,animation:!0,visual:!0},light:{cls:glam.LightElement,transform:!0,animation:!0},particles:{cls:glam.ParticlesElement,transform:!0,animation:!0},effect:{cls:glam.EffectElement}};glam.DOMTypes.parseVector3Array=function(a,b){var c=a.textContent.split(" "),d,e=c.length;if(!(3>e))for(d=0;d<e;d+=3){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),l=parseFloat(c[d+2]),f=new THREE.Vector3(f,g,l);b.push(f)}};
glam.DOMTypes.parseVector3=function(a,b){var c=a.split(" ");if(!(3>c.length)){var d=parseFloat(c[0]),e=parseFloat(c[1]),c=parseFloat(c[2]);b.set(d,e,c)}};glam.DOMTypes.parseVector2Array=function(a,b){var c=a.textContent.split(" "),d,e=c.length;if(!(2>e))for(d=0;d<e;d+=2){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),f=new THREE.Vector2(f,g);b.push(f)}};
glam.DOMTypes.parseColor3Array=function(a,b){var c=a.textContent.split(" "),d,e=c.length;if(!(3>e))for(d=0;d<e;d+=3){var f=parseFloat(c[d]),g=parseFloat(c[d+1]),l=parseFloat(c[d+2]),f=new THREE.Color(f,g,l);b.push(f)}};glam.DOMTypes.parseColor3=function(a,b){var c=a.split(" ");if(!(3>c.length)){var d=parseFloat(c[0]),e=parseFloat(c[1]),c=parseFloat(c[2]);b.setRGB(d,e,c)}};
glam.DOMTypes.parseFaceArray=function(a,b){var c=a.textContent.split(" "),d,e=c.length;if(!(1>e))for(d=0;d<e;d+=3){var f=parseInt(c[d]),g=parseInt(c[d+1]),l=parseInt(c[d+2]),f=new THREE.Face3(f,g,l);b.push(f)}};glam.DOMTypes.parseUVArray=function(a,b){var c=a.textContent.split(" "),d,e=c.length;if(!(6>e))for(d=0;d<e;d+=6){for(var f=[],g=0;3>g;g++){var l=parseFloat(c[d+2*g]),h=parseFloat(c[d+2*g+1]),l=new THREE.Vector2(l,h);f.push(l)}b.push(f)}};glam.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*k.autoRotateSpeed}function d(a){!1!==k.enabled&&!1!==k.userRotate&&(a.preventDefault(),0===a.button||k.oneButton&&2===a.button?(A=z.ROTATE,p.set(a.clientX,a.clientY)):1===a.button&&k.userZoom?(A=z.ZOOM,x.set(a.clientX,a.clientY)):2===a.button&&k.userPan&&(A=z.PAN),k.domElement.addEventListener("mousemove",e,!1),k.domElement.addEventListener("mouseup",l,!1),k.domElement.addEventListener("touchmove",f,!1),k.domElement.addEventListener("touchend",
h,!1))}function e(a){!1!==k.enabled&&(a.preventDefault(),A===z.ROTATE?(u.set(a.clientX,a.clientY),w.subVectors(u,p),k.rotateLeft(2*Math.PI*w.x/t*k.userRotateSpeed),k.rotateUp(2*Math.PI*w.y/t*k.userRotateSpeed),p.copy(u)):A===z.ZOOM?(q.set(a.clientX,a.clientY),n.subVectors(q,x),0<n.y?k.zoomIn():k.zoomOut(),x.copy(q)):A===z.PAN&&k.pan(new THREE.Vector3(-(a.movementX||a.mozMovementX||a.webkitMovementX||0),a.movementY||a.mozMovementY||a.webkitMovementY||0,0)))}function f(a){if(!1!==k.enabled)if(1<a.changedTouches.length){for(var b=
null,c=null,d=0;d<a.changedTouches.length;d++)a.changedTouches[d].identifier==k.touchId0?b=a.changedTouches[d]:a.changedTouches[d].identifier==k.touchId1&&(c=a.changedTouches[d]);b&&(c&&k.userZoom)&&(a=g(b,c),b=a-k.touchDistance,0<b?k.zoomIn():0>b&&k.zoomOut(),k.touchDistance=a)}else k.userRotate&&e({type:"mousemove",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.changedTouches[0].screenX,screenY:a.changedTouches[0].screenY,clientX:a.changedTouches[0].clientX,clientY:a.changedTouches[0].clientY,
pageX:a.changedTouches[0].pageX,pageY:a.changedTouches[0].pageY,button:0,preventDefault:function(){}})}function g(a,b){var c=b.clientX-a.clientX,d=b.clientY-a.clientY;return Math.sqrt(c*c+d*d)}function l(a){document.removeEventListener("mousemove",e,!1);document.removeEventListener("mouseup",l,!1);k.domElement.removeEventListener("touchmove",f,!1);k.domElement.removeEventListener("touchend",h,!1);A=z.NONE}function h(a){1<a.changedTouches.length||l({type:"mouseup",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,
detail:a.detail,screenX:a.changedTouches[0].screenX,screenY:a.changedTouches[0].screenY,clientX:a.changedTouches[0].clientX,clientY:a.changedTouches[0].clientY,pageX:a.changedTouches[0].pageX,pageY:a.changedTouches[0].pageY,button:0,preventDefault:function(){}})}function m(a){a.preventDefault();if(!1!==k.enabled&&!1!==k.userZoom){var b=0;a.wheelDelta?b=a.wheelDelta:a.detail&&(b=-a.detail);0<b?k.zoomIn():k.zoomOut()}}this.object=a;this.domElement=void 0!==b?b:document;this.enabled=!0;this.center=new THREE.Vector3;
this.userZoom=!0;this.userZoomSpeed=1;this.userRotate=!0;this.userRotateSpeed=1;this.userPan=!0;this.userPanSpeed=2;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.minDistance=0;this.maxDistance=Infinity;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.usekeys=this.oneButton=!1;var k=this,t=1800,p=new THREE.Vector2,u=new THREE.Vector2,w=new THREE.Vector2,x=new THREE.Vector2,q=new THREE.Vector2,n=new THREE.Vector2,r=0,y=0,s=1,B=new THREE.Vector3,z={NONE:-1,
ROTATE:0,ZOOM:1,PAN:2},A=z.NONE,C={type:"change"};this.rotateLeft=function(a){void 0===a&&(a=c());y-=a};this.rotateRight=function(a){void 0===a&&(a=c());y+=a};this.rotateUp=function(a){void 0===a&&(a=c());r-=a};this.rotateDown=function(a){void 0===a&&(a=c());r+=a};this.zoomIn=function(a){void 0===a&&(a=Math.pow(1/0.95,k.userZoomSpeed));s/=a};this.zoomOut=function(a){void 0===a&&(a=Math.pow(1/0.95,k.userZoomSpeed));s*=a};this.pan=function(a){a.transformDirection(this.object.matrix);a.multiplyScalar(k.userPanSpeed);
this.object.position.add(a);this.center.add(a)};this.update=function(){var a=this.object.position,b=a.clone().sub(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&this.rotateLeft(c());var d=d+y,e=e+r,e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),f=b.length()*s,f=Math.max(this.minDistance,Math.min(this.maxDistance,f));b.x=f*Math.sin(e)*Math.sin(d);b.y=f*Math.cos(e);b.z=f*Math.sin(e)*Math.cos(d);
a.copy(this.center).add(b);this.object.lookAt(this.center);r=y=0;s=1;0<B.distanceTo(this.object.position)&&(this.dispatchEvent(C),B.copy(this.object.position))};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",d,!1);this.domElement.addEventListener("touchstart",function(a){1<a.touches.length?(k.touchDistance=g(a.touches[0],a.touches[1]),k.touchId0=a.touches[0].identifier,k.touchId1=a.touches[1].identifier):d({type:"mousedown",
view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.touches[0].screenX,screenY:a.touches[0].screenY,clientX:a.touches[0].clientX,clientY:a.touches[0].clientY,pageX:a.touches[0].pageX,pageY:a.touches[0].pageY,button:0,preventDefault:function(){}})},!1);this.domElement.addEventListener("mousewheel",m,!1);this.domElement.addEventListener("DOMMouseScroll",m,!1);this.domElement.addEventListener("keydown",function(a){if(k.usekeys&&!1!==k.enabled&&!1!==k.userPan)switch(a.keyCode){case k.keys.UP:k.pan(new THREE.Vector3(0,
1,0));break;case k.keys.BOTTOM:k.pan(new THREE.Vector3(0,-1,0));break;case k.keys.LEFT:k.pan(new THREE.Vector3(-1,0,0));break;case k.keys.RIGHT:k.pan(new THREE.Vector3(1,0,0))}},!1)};glam.OrbitControls.prototype=Object.create(THREE.EventDispatcher.prototype);glam.TextElement={};glam.TextElement.DEFAULT_FONT_SIZE=1;glam.TextElement.DEFAULT_FONT_DEPTH=0.2;glam.TextElement.DEFAULT_FONT_BEVEL="none";glam.TextElement.DEFAULT_BEVEL_SIZE=0.01;glam.TextElement.DEFAULT_BEVEL_THICKNESS=0.02;glam.TextElement.DEFAULT_FONT_FAMILY="helvetica";glam.TextElement.DEFAULT_FONT_WEIGHT="normal";glam.TextElement.DEFAULT_FONT_STYLE="normal";glam.TextElement.BEVEL_EPSILON=1E-4;glam.TextElement.DEFAULT_VALUE="";
glam.TextElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.TextElement)};
glam.TextElement.getAttributes=function(a,b,c){var d=a.getAttribute("fontFamily")||glam.TextElement.DEFAULT_FONT_FAMILY,e=a.getAttribute("fontWeight")||glam.TextElement.DEFAULT_FONT_WEIGHT,f=a.getAttribute("fontStyle")||glam.TextElement.DEFAULT_FONT_STYLE,g=a.getAttribute("fontSize")||glam.TextElement.DEFAULT_FONT_SIZE,l=a.getAttribute("fontDepth")||glam.TextElement.DEFAULT_FONT_DEPTH,h=a.getAttribute("fontBevel")||glam.TextElement.DEFAULT_FONT_BEVEL,m=a.getAttribute("bevelSize")||glam.TextElement.DEFAULT_BEVEL_SIZE,
k=a.getAttribute("bevelThickness")||glam.TextElement.DEFAULT_BEVEL_THICKNESS;b&&(b["font-family"]&&(d=b["font-family"]),b["font-weight"]&&(e=b["font-weight"]),b["font-style"]&&(f=b["font-style"]),b["font-size"]&&(g=b["font-size"]),b["font-depth"]&&(l=b["font-depth"]),b["font-bevel"]&&(h=b["font-bevel"]),b["bevel-size"]&&(m=b["bevel-size"]),b["bevel-thickness"]&&(k=b["bevel-thickness"]));d=d.toLowerCase();switch(d){case "optima":d="optimer";break;default:d="helvetiker"}THREE.FontUtils.faces[d]||(d=
"helvetiker");e=e.toLowerCase();"bold"!=e&&(e="normal");f.toLowerCase();f="normal";g=parseFloat(g);l=parseFloat(l);m=parseFloat(m);k=parseFloat(k);bevelEnabled="bevel"==h.toLowerCase()?!0:!1;l||(bevelEnabled=!1);bevelEnabled||(k=m=glam.TextElement.BEVEL_EPSILON,bevelEnabled=!0);b=a.getAttribute("value")||glam.TextElement.DEFAULT_VALUE;b||(b=a.textContent);c.value=b;c.fontSize=g;c.fontDepth=l;c.bevelSize=m;c.bevelThickness=k;c.bevelEnabled=bevelEnabled;c.fontFamily=d;c.fontWeight=e;c.fontStyle=f};
...
glam.Viewer.GRID_OPACITY=0.2;glam.Viewer.DEFAULT_HEADLIGHT_INTENSITY=1;glam.OculusRiftControls=function(a){var b=this,c=!1,d=!1,e=!1,f=!1,g=!1,l=!1,h=new THREE.Vector3;this.moveSpeed=0.03;this.jumpSpeed=2;var m=new THREE.Quaternion,k=new THREE.Vector3(1,0,0),t=new THREE.Vector3(0,0,1),p=function(a){switch(a.keyCode){case 38:case 87:c=!0;break;case 37:case 65:e=!0;break;case 40:case 83:d=!0;break;case 39:case 68:f=!0;break;case 32:!0===l&&(h.y+=this.jumpSpeed),l=!1}}.bind(this);document.addEventListener("mousemove",function(c){if(!1!==b.enabled){var d=c.movementX||c.mozMovementX||
c.webkitMovementX||0;c=c.movementY||c.mozMovementY||c.webkitMovementY||0;console.log(d,c);m.setFromAxisAngle(t,0.002*d);a.quaternion.multiplySelf(m);m.setFromAxisAngle(k,0.002*c);a.quaternion.multiplySelf(m)}},!1);document.addEventListener("keydown",p,!1);document.addEventListener("keyup",function(a){switch(a.keyCode){case 38:case 87:c=!1;break;case 37:case 65:e=!1;break;case 40:case 83:d=!1;break;case 39:case 68:f=!1}},!1);this.enabled=!1;this.getObject=function(){return a};this.isOnObject=function(a){l=
g=a};this.update=function(b,k){b*=0.1;h.x+=0.08*-h.x*b;h.z+=0.08*-h.z*b;h.y-=0.1*b;c&&(h.z-=this.moveSpeed*b);d&&(h.z+=this.moveSpeed*b);e&&(h.x-=this.moveSpeed*b);f&&(h.x+=this.moveSpeed*b);!0===g&&(h.y=Math.max(0,h.y));var m=new THREE.Quaternion;new THREE.Euler;k&&(m.set(k.hmd.rotation[0],k.hmd.rotation[1],k.hmd.rotation[2],k.hmd.rotation[3]),0==m.x&&0==m.y&&0==m.z&&0==m.w||a.quaternion.copy(m));10>a.position.y&&(h.y=0,l=!0)}};glam.PickManager={};
...
glam.ParticlesElement.parseEmitter=function(a,b){var c=parseFloat(a.getAttribute("size")),d=parseFloat(a.getAttribute("sizeEnd")),e=parseInt(a.getAttribute("particlesPerSecond")),f=parseFloat(a.getAttribute("opacityStart")),g=parseFloat(a.getAttribute("opacityMiddle")),l=parseFloat(a.getAttribute("opacityEnd")),h,m;if(css=a.getAttribute("colorStart"))h=(new THREE.Color).setStyle(css);if(css=a.getAttribute("colorEnd"))m=(new THREE.Color).setStyle(css);var k=parseFloat(a.getAttribute("vx"))||0,t=parseFloat(a.getAttribute("vy"))||
0,p=parseFloat(a.getAttribute("vz"))||0,u=parseFloat(a.getAttribute("ax"))||0,w=parseFloat(a.getAttribute("ay"))||0,x=parseFloat(a.getAttribute("az"))||0,q=parseFloat(a.getAttribute("psx"))||0,n=parseFloat(a.getAttribute("psy"))||0,r=parseFloat(a.getAttribute("psz"))||0,y=parseFloat(a.getAttribute("asx"))||0,s=parseFloat(a.getAttribute("asy"))||0,B=parseFloat(a.getAttribute("asz"))||0,k=new THREE.Vector3(k,t,p),u=new THREE.Vector3(u,w,x),q=new THREE.Vector3(q,n,r),y=new THREE.Vector3(y,s,B);(s=a.getAttribute("velocity"))&&
glam.DOMTypes.parseVector3(s,k);(s=a.getAttribute("acceleration"))&&glam.DOMTypes.parseVector3(s,u);(s=a.getAttribute("positionSpread"))&&glam.DOMTypes.parseVector3(s,q);(s=a.getAttribute("accelerationSpread"))&&glam.DOMTypes.parseVector3(s,y);s=THREE.NoBlending;switch((a.getAttribute("blending")||"").toLowerCase()){case "normal":s=THREE.NormalBlending;break;case "additive":s=THREE.AdditiveBlending;break;case "subtractive":s=THREE.SubtractiveBlending;break;case "multiply":s=THREE.MultiplyBlending;
break;case "custom":s=THREE.CustomBlending}b.size=c;b.sizeEnd=d;void 0!==h&&(b.colorStart=h);void 0!==m&&(b.colorEnd=m);b.particlesPerSecond=e;b.opacityStart=f;b.opacityMiddle=g;b.opacityEnd=l;b.velocity=k;b.acceleration=u;b.positionSpread=q;b.accelerationSpread=y;b.blending=s};glam.ParticlesElement.addEmitters=function(a,b){var c,d=a.length;for(c=0;c<d;c++)b.addComponent(a[c])};glam.ParticlesElement.DEFAULT_MAX_AGE=1;glam.RotateBehavior=function(a){a=a||{};this.duration=void 0!==a.duration?a.duration:1;this.velocity=void 0!==a.velocity?a.velocity:Math.PI/2/this.duration;this.angle=this.startAngle=0;glam.Behavior.call(this,a)};goog.inherits(glam.RotateBehavior,glam.Behavior);glam.RotateBehavior.prototype.start=function(){this.angle=0;this._object.transform.rotation.y%=2*Math.PI;this.startAngle=this._object.transform.rotation.y;glam.Behavior.prototype.start.call(this)};
...
d=c.clone().sub(e).sub(f),g=c.clone().add(e).sub(f),l=c.clone().add(e).add(f),e=c.clone().sub(e).add(f),c=new THREE.Geometry;c.vertices.push(d,g,l,e);d=new THREE.Face3(0,1,2);d.normal.copy(b);d.vertexNormals.push(b.clone(),b.clone(),b.clone(),b.clone());c.faces.push(d);d=new THREE.Face3(0,2,3);d.normal.copy(b);d.vertexNormals.push(b.clone(),b.clone(),b.clone(),b.clone());c.faces.push(d);c.computeFaceNormals();c.computeCentroids();b=new THREE.MeshBasicMaterial({color:a,transparent:!0,side:THREE.DoubleSide,
...
glam.DeviceOrientationControllerScript.prototype.setCamera=function(a){this._camera=a;this.controls=this.createControls(a)};glam.ControllerElement={};
...
e&&glam.DOMTransform.parseTransform(e,d);b&&glam.DOMTransform.parseStyle(b,d);c.transform.position.set(d.x,d.y,d.z);c.transform.rotation.set(d.rx,d.ry,d.rz);c.transform.scale.set(d.sx,d.sy,d.sz);a.glam.setAttributeHandlers.push(function(b,d){glam.DOMTransform.onSetAttribute(c,a,b,d)});b.setPropertyHandlers.push(function(b,d){glam.DOMTransform.onSetAttribute(c,a,b,d)})};
glam.DOMTransform.parseStyle=function(a,b){a&&(a.x&&(b.x=parseFloat(a.x)),a.y&&(b.y=parseFloat(a.y)),a.z&&(b.z=parseFloat(a.z)),a.rx&&(b.rx=glam.DOMTransform.parseRotation(a.rx)),a.ry&&(b.ry=glam.DOMTransform.parseRotation(a.ry)),a.rz&&(b.rz=glam.DOMTransform.parseRotation(a.rz)),a.sx&&(b.sx=parseFloat(a.sx)),a.sy&&(b.sy=parseFloat(a.sy)),a.sz&&(b.sz=parseFloat(a.sz)),a.transform&&glam.DOMTransform.parseTransform(a.transform,b))};
