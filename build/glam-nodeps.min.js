...
return m&&k?new THREE.ShaderMaterial({vertexShader:m,fragmentShader:k,uniforms:g}):null}if(a=glam.DOMMaterial.getShaderMaterial(l,h))return a;glam.DOMMaterial.addShaderMaterialCallback(l,h,c);glam.DOMMaterial.getShaderMaterialLoading(l,h)||(glam.DOMMaterial.setShaderMaterialLoading(l,h),k=m="",glam.System.ajax({type:"GET",url:l,dataType:"text",success:function(a){m=a;k&&d()}}),glam.System.ajax({type:"GET",url:h,dataType:"text",success:function(a){k=a;m&&d()}}))};
