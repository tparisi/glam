...
glam.SkyboxScript.prototype.realize=function(){this.uniforms=this._object.getComponent(glam.Visual).material.uniforms;this.camera=glam.Graphics.instance.backgroundLayer.camera;this.camera.far=2E4;this.camera.position.set(0,0,0)};glam.SkyboxScript.prototype.update=function(){var a=glam.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};glam.SurfaceElement={};glam.SurfaceElement.DEFAULT_WIDTH=2;glam.SurfaceElement.DEFAULT_HEIGHT=2;glam.SurfaceElement.DEFAULT_WIDTH_SEGMENTS=1;glam.SurfaceElement.DEFAULT_CURVATURE=0;glam.SurfaceElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.SurfaceElement)};
glam.SurfaceElement.getAttributes=function(a,b,c){var d=a.getAttribute("width")||glam.SurfaceElement.DEFAULT_WIDTH,e=a.getAttribute("height")||glam.SurfaceElement.DEFAULT_HEIGHT,f=a.getAttribute("width")||glam.SurfaceElement.DEFAULT_WIDTH_SEGMENTS,g=a.getAttribute("height")||glam.SurfaceElement.DEFAULT_HEIGHT_SEGMENTS;a=a.getAttribute("curvature")||glam.SurfaceElement.DEFAULT_CURVATURE;var k=0,h=0,m=0,l=0,n=0,q=0;b&&(b.width&&(d=b.width),b.height&&(e=b.height),b.widthSegments&&(f=b.widthSegments),
b.heightSegments&&(g=b.heightSegments),b.curvature&&(a=b.curvature),b.border&&(k=b.border),b["border-radius"]&&(h=b["border-radius"]),l=b["border-top-radius"]?b["border-top-radius"]:h,m=b["border-left-radius"]?b["border-left-radius"]:h,n=b["border-right-radius"]?b["border-right-radius"]:h,q=b["border-bottom-radius"]?b["border-bottom-radius"]:h);d=parseFloat(d);e=parseFloat(e);f=parseInt(f);g=parseInt(g);a=parseInt(a);k=parseInt(k);h=parseInt(h);l=parseInt(l);m=parseInt(m);n=parseInt(n);q=parseInt(q);
c.width=d;c.height=e;c.widthSegments=f;c.heightSegments=g;c.curvature=a;c.border=k;c.borderRadius=h;c.borderRadiusTop=l;c.borderRadiusLeft=m;c.borderRadiusRight=n;c.borderRadiusBottom=q};glam.SurfaceElement.createVisual=function(a,b,c){a=b.clone();a.map=this.createTexture(c);a.depthWrite=!1;return new glam.Visual({geometry:new THREE.PlaneGeometry(c.width,c.height,c.widthSegments,c.heightSegments),material:a})};
glam.SurfaceElement.createTexture=function(a){var b=a.height/a.width;this.canvas=document.createElement("canvas");this.canvas.width=2048;this.canvas.height=2048*b;b=this.canvas.getContext("2d");b.fillStyle="white";b.strokeStyle="cyan";b.lineWidth=a.border;this.roundRect(b,0,0,this.canvas.width,this.canvas.height,{left:a.borderRadiusLeft,right:a.borderRadiusRight,top:a.borderRadiusTop,bottom:a.borderRadiusBottom},!1,a.border);b.font=(72).toString()+"px Helvetica Neue";b.fillStyle="cyan";b.fillText("GLAM <surface> Prototype",
50,200);a=new THREE.Texture(this.canvas);a.needsUpdate=!0;return a};
glam.SurfaceElement.roundRect=function(a,b,c,d,e,f,g,k){"undefined"==typeof k&&(k=!0);"undefined"===typeof f&&(f=5);a.beginPath();a.moveTo(b+f.left,c);a.lineTo(b+d-f.right,c);a.quadraticCurveTo(b+d,c,b+d,c+f.top);a.lineTo(b+d,c+e-f.bottom);a.quadraticCurveTo(b+d,c+e,b+d-f.right,c+e);a.lineTo(b+f.left,c+e);a.quadraticCurveTo(b,c+e,b,c+e-f.bottom);a.lineTo(b,c+f.top);a.quadraticCurveTo(b,c,b+f.left,c);a.closePath();k&&a.stroke();g&&a.fill()};glam.LineElement={};glam.LineElement.create=function(a,b){var c=glam.DOMMaterial.create(b,null,"line"),d=new THREE.Geometry;glam.LineElement.parse(a,d,c);var e=new THREE.Line(d,c),f=new glam.Object,e=new glam.Visual({object:e});f.addComponent(e);a.geometry=d;a.material=c;return f};
...
glam.ParticleEmitter.DEFAULT_OPACITY_MIDDLE,k=this.param.opacityEnd||glam.ParticleEmitter.DEFAULT_OPACITY_END,h=this.param.velocity||glam.ParticleEmitter.DEFAULT_VELOCITY,m=this.param.acceleration||glam.ParticleEmitter.DEFAULT_ACCELERATION,l=this.param.positionSpread||glam.ParticleEmitter.DEFAULT_POSITION_SPREAD,n=this.param.accelerationSpread||glam.ParticleEmitter.DEFAULT_ACCELERATION_SPREAD,q=this.param.blending||glam.ParticleEmitter.DEFAULT_BLENDING;this._active=!1;this.object=new ShaderParticleEmitter({size:a,
sizeEnd:b,colorStart:c,colorEnd:d,particlesPerSecond:e,opacityStart:f,opacityMiddle:g,opacityEnd:k,velocity:h,acceleration:m,positionSpread:l,accelerationSpread:n,blending:q});Object.defineProperties(this,{active:{get:function(){return this._active},set:function(a){this.setActive(a)}}})};goog.inherits(glam.ParticleEmitter,glam.Component);glam.ParticleEmitter.prototype.realize=function(){};glam.ParticleEmitter.prototype.update=function(){};
...
if(a["backface-visibility"])switch(a["backface-visibility"].toLowerCase()){case "visible":h=THREE.DoubleSide;break;case "hidden":h=THREE.FrontSide}var l;a.hasOwnProperty("render-mode")&&(l="wireframe"==a["render-mode"]);var n;a["line-width"]&&(n=parseInt(a["line-width"]));var q;a["dash-size"]&&(q=parseInt(a["dash-size"]));var t;a["gap-size"]&&(t=parseInt(a["gap-size"]));a={};b.image&&(a.map=THREE.ImageUtils.loadTexture(b.image));b.envMap&&(a.envMap=b.envMap);b.normalMap&&(a.normalMap=THREE.ImageUtils.loadTexture(b.normalMap));
b.bumpMap&&(a.bumpMap=THREE.ImageUtils.loadTexture(b.bumpMap));b.specularMap&&(a.specularMap=THREE.ImageUtils.loadTexture(b.specularMap));void 0!==e&&(a.color=e);void 0!==f&&(a.color=f);void 0!==g&&(a.specular=g);void 0!==k&&(a.ambient=k);void 0!==m&&(a.opacity=m,a.transparent=1>m);void 0!==l&&(a.wireframe=l);void 0!==n&&(a.linewidth=n);void 0!==q&&(a.dashSize=q);void 0!==t&&(a.gapSize=t);void 0!==c&&(a.reflectivity=c);void 0!==d&&(a.refractionRatio=d);a.side=h;return a};
...
b.split("\\s+"),a=f[0],d=f[1],e=f[2],f=f[4];d=d||glam.AnimationElement.DEFAULT_DURATION;d=glam.AnimationElement.parseTime(d);e=e||glam.AnimationElement.DEFAULT_TIMING_FUNCTION;e=glam.AnimationElement.parseTimingFunction(e);f=f||glam.AnimationElement.DEFAULT_ITERATION_COUNT;f="infinite"==f.toLowerCase()?!0:!1;if(a){a=glam.DOM.getStyle(a);b=[];for(var g in a){var k;k="from"==g?0:"to"==g?1:glam.AnimationElement.parseFrameTime(g);var h,m=a[g],l;for(l in m){var n=m[l],q;if("transform"==l||"-webkit-transform"==
l||"-moz-transform"==l)q="transform",h={},glam.DOMTransform.parseTransform(n,h);else if("opacity"==l||"color"==l)q="material",h=glam.DOMMaterial.parseStyle(m);b.push({time:k,value:h,type:q})}}d=glam.AnimationElement.build(d,f,e,b);glam.AnimationElement.addAnimationToObject(d,c)}};
glam.AnimationElement.build=function(a,b,c,d){var e=[],f=[],g=[],k=[],h=[],m=[],l=[],n=[],q=[],t=[],w,y=d.length;for(w=0;w<y;w++){var u=d[w],p=u.value;if("transform"==u.type){if("x"in p||"y"in p||"z"in p){e.push(u.time);var r={};"x"in p&&(r.x=p.x);"y"in p&&(r.y=p.y);"z"in p&&(r.z=p.z);f.push(r)}if("rx"in p||"ry"in p||"rz"in p)g.push(u.time),r={},"rx"in p&&(r.x=p.rx),"ry"in p&&(r.y=p.ry),"rz"in p&&(r.z=p.rz),k.push(r);if("sx"in p||"sy"in p||"sz"in p)h.push(u.time),r={},"sx"in p&&(r.x=p.sx),"sy"in p&&
(r.y=p.sy),"sz"in p&&(r.z=p.sz),m.push(r)}else"material"==u.type&&("opacity"in p&&(l.push(u.time),n.push({opacity:parseFloat(p.opacity)})),"color"in p&&(q.push(u.time),u=new THREE.Color(p.color),t.push({r:u.r,g:u.g,b:u.b})))}return{duration:a,loop:b,easing:c,poskeys:e,posvalues:f,rotkeys:g,rotvalues:k,sclkeys:h,sclvalues:m,opakeys:l,opavalues:n,colorkeys:q,colorvalues:t}};
...
1,0),m=new THREE.Vector3(0,0,0),l=new THREE.Euler,n=new THREE.Quaternion,q=new THREE.Quaternion(-Math.sqrt(0.5),0,0,Math.sqrt(0.5));this.deviceOrientation={};this.screenOrientation=window.orientation||0;this.onDeviceOrientationChangeEvent=function(a){this.deviceOrientation=a}.bind(this);var t=function(){switch(window.screen.orientation||window.screen.mozOrientation){case "landscape-primary":return 90;case "landscape-secondary":return-90;case "portrait-secondary":return 180;case "portrait-primary":return 0}return window.orientation||
0};this.onScreenOrientationChangeEvent=function(){this.screenOrientation=t()}.bind(this);this.update=function(a){return function(){if(!this.freeze){var a=t();a!==this.screenOrientation&&(this.screenOrientation=a,this.autoAlign=!0);this.alpha=this.deviceOrientation.gamma?THREE.Math.degToRad(this.deviceOrientation.alpha):0;this.beta=this.deviceOrientation.beta?THREE.Math.degToRad(this.deviceOrientation.beta):0;this.gamma=this.deviceOrientation.gamma?THREE.Math.degToRad(this.deviceOrientation.gamma):
0;this.orient=this.screenOrientation?THREE.Math.degToRad(this.screenOrientation):0;l.set(this.beta,this.alpha,-this.gamma,"YXZ");b.setFromEuler(l);c.slerp(b,0.5);this.autoAlign?this.orientationQuaternion.copy(b):this.orientationQuaternion.copy(c);this.orientationQuaternion.multiply(q);this.orientationQuaternion.multiply(n.setFromAxisAngle(k,-this.orient));this.object.quaternion.copy(this.alignQuaternion);this.object.quaternion.multiply(this.orientationQuaternion);this.autoForward&&(d.set(0,0,-1).applyQuaternion(this.object.quaternion,
...
l=a.getAttribute("bevelThickness")||glam.TextElement.DEFAULT_BEVEL_THICKNESS,n=a.getAttribute("fontRender")||glam.TextElement.DEFAULT_FONT_RENDER,q=a.getAttribute("width")||glam.TextElement.DEFAULT_WIDTH,t=a.getAttribute("height")||glam.TextElement.DEFAULT_HEIGHT;b&&(b["font-family"]&&(d=b["font-family"]),b["font-weight"]&&(e=b["font-weight"]),b["font-style"]&&(f=b["font-style"]),b["font-size"]&&(g=b["font-size"]),b["font-depth"]&&(k=b["font-depth"]),b["font-bevel"]&&(h=b["font-bevel"]),b["bevel-size"]&&
(m=b["bevel-size"]),b["bevel-thickness"]&&(l=b["bevel-thickness"]),b["font-render"]&&(n=b["font-render"]));d=d.toLowerCase();n=n.toLowerCase();if("polygon"==n)switch(d){case "optima":d="optimer";break;default:d="helvetiker"}THREE.FontUtils.faces[d]||"polygon"!=n||(d="helvetiker");e=e.toLowerCase();"bold"!=e&&"polygon"==n&&(e="normal");f=f.toLowerCase();"polygon"==n&&(f="normal");g=parseFloat(g);k=parseFloat(k);m=parseFloat(m);l=parseFloat(l);h="bevel"==h.toLowerCase()?!0:!1;k||(h=!1);h||(l=m=glam.TextElement.BEVEL_EPSILON,
h=!0);var w=a.getAttribute("value")||glam.TextElement.DEFAULT_VALUE;w||(w=a.textContent);c.value=w;c.fontSize=g;c.fontDepth=k;c.bevelSize=m;c.bevelThickness=l;c.bevelEnabled=h;c.fontFamily=d;c.fontWeight=e;c.fontStyle=f;c.fontRender=n;c.width=q;c.height=t;b&&(c.color=b.color)};glam.TextElement.createVisual=function(a,b,c){return c.value?"polygon"==c.fontRender?glam.TextElement.createPolygonText(a,b,c):"bitmap"==c.fontRender?glam.TextElement.createBitmapText(a,b,c):null:null};
...
material:b});a.center();return b};glam.TextElement.createBitmapText=function(a,b,c){a=b.clone();a.color.setRGB(1,1,1);a.map=this.createTexture(c);a.depthWrite=!1;return new glam.Visual({geometry:new THREE.PlaneGeometry(c.width,c.height,c.widthSegments,c.heightSegments),material:a})};
glam.TextElement.createTexture=function(a){var b=a.height/a.width,c=document.createElement("canvas");c.width=2048;c.height=2048*b;b=c.getContext("2d");b.fillStyle="white";b.font=a.fontStyle+" "+(144*a.fontSize).toString()+"px "+a.fontFamily;b.fillStyle=a.color;b.fillText(a.value,144,144);a=new THREE.Texture(c);a.needsUpdate=!0;return a};glam.CylinderElement={};glam.CylinderElement.DEFAULT_RADIUS=2;glam.CylinderElement.DEFAULT_HEIGHT=2;glam.CylinderElement.create=function(a,b){return glam.VisualElement.create(a,b,glam.CylinderElement)};glam.CylinderElement.getAttributes=function(a,b,c){var d=a.getAttribute("radius")||glam.CylinderElement.DEFAULT_RADIUS;a=a.getAttribute("height")||glam.CylinderElement.DEFAULT_HEIGHT;b&&(b.radius&&(d=b.radius),b.height&&(a=b.height));d=parseFloat(d);a=parseFloat(a);c.radius=d;c.height=a};
...
glam.ParticlesElement.parseEmitter=function(a,b){var c=parseFloat(a.getAttribute("size")),d=parseFloat(a.getAttribute("sizeEnd")),e=parseInt(a.getAttribute("particlesPerSecond")),f=parseFloat(a.getAttribute("opacityStart")),g=parseFloat(a.getAttribute("opacityMiddle")),k=parseFloat(a.getAttribute("opacityEnd")),h,m,l;if(l=a.getAttribute("colorStart"))h=(new THREE.Color).setStyle(l);if(l=a.getAttribute("colorEnd"))m=(new THREE.Color).setStyle(l);l=parseFloat(a.getAttribute("vx"))||0;var n=parseFloat(a.getAttribute("vy"))||
0,q=parseFloat(a.getAttribute("vz"))||0,t=parseFloat(a.getAttribute("ax"))||0,w=parseFloat(a.getAttribute("ay"))||0,y=parseFloat(a.getAttribute("az"))||0,u=parseFloat(a.getAttribute("psx"))||0,p=parseFloat(a.getAttribute("psy"))||0,r=parseFloat(a.getAttribute("psz"))||0,x=parseFloat(a.getAttribute("asx"))||0,s=parseFloat(a.getAttribute("asy"))||0,B=parseFloat(a.getAttribute("asz"))||0;l=new THREE.Vector3(l,n,q);t=new THREE.Vector3(t,w,y);u=new THREE.Vector3(u,p,r);x=new THREE.Vector3(x,s,B);(s=a.getAttribute("velocity"))&&
glam.DOMTypes.parseVector3(s,l);(s=a.getAttribute("acceleration"))&&glam.DOMTypes.parseVector3(s,t);(s=a.getAttribute("positionSpread"))&&glam.DOMTypes.parseVector3(s,u);(s=a.getAttribute("accelerationSpread"))&&glam.DOMTypes.parseVector3(s,x);s=THREE.NoBlending;switch((a.getAttribute("blending")||"").toLowerCase()){case "normal":s=THREE.NormalBlending;break;case "additive":s=THREE.AdditiveBlending;break;case "subtractive":s=THREE.SubtractiveBlending;break;case "multiply":s=THREE.MultiplyBlending;
break;case "custom":s=THREE.CustomBlending}b.size=c;b.sizeEnd=d;void 0!==h&&(b.colorStart=h);void 0!==m&&(b.colorEnd=m);b.particlesPerSecond=e;b.opacityStart=f;b.opacityMiddle=g;b.opacityEnd=k;b.velocity=l;b.acceleration=t;b.positionSpread=u;b.accelerationSpread=x;b.blending=s};glam.ParticlesElement.addEmitters=function(a,b){var c,d=a.length;for(c=0;c<d;c++)b.addComponent(a[c])};glam.ParticlesElement.DEFAULT_MAX_AGE=1;glam.BackgroundElement={};glam.BackgroundElement.DEFAULT_BACKGROUND_TYPE="box";
...
h,!1))}function e(a){!1!==l.enabled&&(a.preventDefault(),A===z.ROTATE?(t.set(a.clientX,a.clientY),w.subVectors(t,q),l.rotateLeft(2*Math.PI*w.x/n*l.userRotateSpeed),l.rotateUp(2*Math.PI*w.y/n*l.userRotateSpeed),q.copy(t)):A===z.ZOOM?(u.set(a.clientX,a.clientY),p.subVectors(u,y),0<p.y?l.zoomIn():l.zoomOut(),y.copy(u)):A===z.PAN&&l.pan(new THREE.Vector3(-(a.movementX||a.mozMovementX||a.webkitMovementX||0),a.movementY||a.mozMovementY||a.webkitMovementY||0,0)))}function f(a){if(!1!==l.enabled)if(1<a.changedTouches.length){for(var b=
...
this.userZoom=!0;this.userZoomSpeed=1;this.userRotate=!0;this.userRotateSpeed=1;this.userPan=!0;this.userPanSpeed=2;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.minDistance=0;this.maxDistance=Infinity;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.usekeys=this.oneButton=!1;var l=this,n=1800,q=new THREE.Vector2,t=new THREE.Vector2,w=new THREE.Vector2,y=new THREE.Vector2,u=new THREE.Vector2,p=new THREE.Vector2,r=0,x=0,s=1,B=new THREE.Vector3,z={NONE:-1,
ROTATE:0,ZOOM:1,PAN:2},A=z.NONE,C={type:"change"};this.rotateLeft=function(a){void 0===a&&(a=c());x-=a};this.rotateRight=function(a){void 0===a&&(a=c());x+=a};this.rotateUp=function(a){void 0===a&&(a=c());r-=a};this.rotateDown=function(a){void 0===a&&(a=c());r+=a};this.zoomIn=function(a){void 0===a&&(a=Math.pow(1/0.95,l.userZoomSpeed));s/=a};this.zoomOut=function(a){void 0===a&&(a=Math.pow(1/0.95,l.userZoomSpeed));s*=a};this.pan=function(a){a.transformDirection(this.object.matrix);a.multiplyScalar(l.userPanSpeed);
this.object.position.add(a);this.center.add(a)};this.update=function(){if(!1!==this.enabled){var a=this.object.position,b=a.clone().sub(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&this.rotateLeft(c());var d=d+x,e=e+r,e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),f=b.length()*s,f=Math.max(this.minDistance,Math.min(this.maxDistance,f));b.x=f*Math.sin(e)*Math.sin(d);b.y=f*Math.cos(e);b.z=f*
Math.sin(e)*Math.cos(d);a.copy(this.center).add(b);this.object.lookAt(this.center);r=x=0;s=1;0<B.distanceTo(this.object.position)&&(this.dispatchEvent(C),B.copy(this.object.position))}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",d,!1);this.domElement.addEventListener("touchstart",function(a){1<a.touches.length?(l.touchDistance=g(a.touches[0],a.touches[1]),l.touchId0=a.touches[0].identifier,l.touchId1=a.touches[1].identifier):
...
glam.Viewer.GRID_OPACITY=0.2;glam.Viewer.DEFAULT_HEADLIGHT_INTENSITY=1;glam.OculusRiftControls=function(a){var b=this,c=!1,d=!1,e=!1,f=!1,g=!1,k=!1,h=new THREE.Vector3;this.moveSpeed=0.03;this.jumpSpeed=2;var m=new THREE.Quaternion,l=new THREE.Vector3(1,0,0),n=new THREE.Vector3(0,0,1),q=function(a){switch(a.keyCode){case 38:case 87:c=!0;break;case 37:case 65:e=!0;break;case 40:case 83:d=!0;break;case 39:case 68:f=!0;break;case 32:!0===k&&(h.y+=this.jumpSpeed),k=!1}}.bind(this);document.addEventListener("mousemove",function(c){if(!1!==b.enabled){var d=c.movementX||c.mozMovementX||
c.webkitMovementX||0;c=c.movementY||c.mozMovementY||c.webkitMovementY||0;console.log(d,c);m.setFromAxisAngle(n,0.002*d);a.quaternion.multiplySelf(m);m.setFromAxisAngle(l,0.002*c);a.quaternion.multiplySelf(m)}},!1);document.addEventListener("keydown",q,!1);document.addEventListener("keyup",function(a){switch(a.keyCode){case 38:case 87:c=!1;break;case 37:case 65:e=!1;break;case 40:case 83:d=!1;break;case 39:case 68:f=!1}},!1);this.enabled=!1;this.getObject=function(){return a};this.isOnObject=function(a){k=
