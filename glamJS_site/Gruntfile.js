module.exports = function ( grunt ) {
  ...
  var taskConfig = {
     ...
     * our project site (images, fonts, etc.) and javascripts into
     * `build_dir`, and then to copy the site to `compile_dir`.
     */
    copy: {
      build_app_assets: {
        files: [
    ...
    delta: {
      ...
      /**
       * When site are changed, copy them. Note that this will *not* copy new
