// goog.provide('FirstPersonControllerScript');

module.exports FirstPersonControllerScript;
...
util.inherits(FirstPersonControllerScript, Script);

Prefabs.FirstPersonController = function(param)
{
	param = param || {};

	var controller = new GlamObject(param);
	var controllerScript = new FirstPersonControllerScript(param);
...
function FirstPersonControllerScript(param)
{
...
FirstPersonControllerScript.prototype.realize = function()
{
	this.headlight = this._object.getComponent(DirectionalLight);
	this.headlight.intensity = this._headlightOn ? 1 : 0;
}

FirstPersonControllerScript.prototype.createControls = function(camera)
{
	var controls = new FirstPersonControls(camera.object, Graphics.instance.container);
...
FirstPersonControllerScript.prototype.update = function()
{
	this.saveCamera();
...
FirstPersonControllerScript.prototype.setEnabled = function(enabled)
{
	this._enabled = enabled;
	this.controls.enabled = enabled;
}

FirstPersonControllerScript.prototype.setMove = function(move)
{
	this._move = move;
	this.controls.movementSpeed = move ? this.moveSpeed : 0;
}

FirstPersonControllerScript.prototype.setLook = function(look)
{
	this._look = look;
	this.controls.lookSpeed = look ? 1.0 : 0;
}

FirstPersonControllerScript.prototype.setMouseLook = function(mouseLook)
{
	this._mouseLook = mouseLook;
	this.controls.mouseLook = mouseLook;
}

FirstPersonControllerScript.prototype.setCamera = function(camera) {
	this._camera = camera;
...
FirstPersonControllerScript.prototype.saveCamera = function() {
	this.savedCameraPos.copy(this._camera.position);
}

FirstPersonControllerScript.prototype.restoreCamera = function() {
	this._camera.position.copy(this.savedCameraPos);
}

FirstPersonControllerScript.prototype.testCollision = function() {
...
FirstPersonControllerScript.prototype.testTerrain = function() {
	return false;
}

FirstPersonControllerScript.prototype.setHeadlightOn = function(on)
{
