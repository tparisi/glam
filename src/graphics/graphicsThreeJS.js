 ...
 * @author Tony Parisi
 */
module.exports = GraphicsThreeJS
...
var CameraManager = require("../cameras/cameraManager");
// TODO: Find composer

var util = require("util");

util.inherits(GraphicsThreeJS, Graphics);

function GraphicsThreeJS()
{
	Graphics.call(this);
}

GraphicsThreeJS.prototype.initialize = function(param)
{
	param = param || {};
...
GraphicsThreeJS.prototype.focus = function()
{
...
GraphicsThreeJS.prototype.initOptions = function(param)
{
	this.displayStats = (param && param.displayStats) ?
			param.displayStats : GraphicsThreeJS.default_display_stats;
}

GraphicsThreeJS.prototype.initPageElements = function(param)
{
    if (param.container)
    {
    ...
    if (this.displayStats)
    {
    	...
    	{
    		System.warn("No Stats module found. Make sure to include stats.min.js");
    	}
    }
}

GraphicsThreeJS.prototype.initScene = function()
{
...
GraphicsThreeJS.prototype.initRenderer = function(param)
{
...
GraphicsThreeJS.prototype.initMouse = function()
{
...
GraphicsThreeJS.prototype.initKeyboard = function()
{
	var dom = this.renderer.domElement;
...
GraphicsThreeJS.prototype.addDomHandlers = function()
{
	var that = this;
...
GraphicsThreeJS.prototype.objectFromMouse = function(event)
{
...
GraphicsThreeJS.prototype.objectFromRay = function(hierarchy, origin, direction, near, far)
{
...
GraphicsThreeJS.prototype.findObjectFromIntersected = function(object, point, face)
{
	if (object.data)
	{
...
GraphicsThreeJS.prototype.nodeFromMouse = function(event)
{
...
GraphicsThreeJS.prototype.getObjectIntersection = function(x, y, object)
{
...
GraphicsThreeJS.prototype.calcElementOffset = function(offset) {
...
GraphicsThreeJS.prototype.onDocumentMouseMove = function(event)
{
    ...
    Mouse.instance.onMouseMove(evt);
    ...
    Application.handleMouseMove(evt);
}

GraphicsThreeJS.prototype.onDocumentMouseDown = function(event)
{
    event.preventDefault();
    ...
    Mouse.instance.onMouseDown(evt);

    if (PickManager)
    {
    	PickManager.handleMouseDown(evt);
    }

    Application.handleMouseDown(evt);
}

GraphicsThreeJS.prototype.onDocumentMouseUp = function(event)
{
    event.preventDefault();
    ...
    Mouse.instance.onMouseUp(evt);

    if (PickManager)
    {
    	PickManager.handleMouseUp(evt);
    }

    Application.handleMouseUp(evt);
}

GraphicsThreeJS.prototype.onDocumentMouseClick = function(event)
{
    event.preventDefault();
    ...
    Mouse.instance.onMouseClick(evt);
    ...
    Application.handleMouseClick(evt);
}

GraphicsThreeJS.prototype.onDocumentMouseDoubleClick = function(event)
{
    event.preventDefault();
    ...
    Mouse.instance.onMouseDoubleClick(evt);

    if (PickManager)
    {
    	PickManager.handleMouseDoubleClick(evt);
    }

    Application.handleMouseDoubleClick(evt);
}

GraphicsThreeJS.prototype.onDocumentMouseScroll = function(event)
{
    event.preventDefault();
    ...
    Mouse.instance.onMouseScroll(evt);

    if (PickManager)
    {
    	PickManager.handleMouseScroll(evt);
    }

    Application.handleMouseScroll(evt);
}

// Touch events
GraphicsThreeJS.prototype.translateTouch = function(touch, offset) {
...
GraphicsThreeJS.prototype.onDocumentTouchStart = function(event)
{
    event.preventDefault();
    ...
    if (PickManager)
    {
    	PickManager.handleTouchStart(evt);
    }

    Application.handleTouchStart(evt);
}

GraphicsThreeJS.prototype.onDocumentTouchMove = function(event)
{
    event.preventDefault();
    ...
    if (PickManager)
    {
    	PickManager.handleTouchMove(evt);
    }

    Application.handleTouchMove(evt);
}

GraphicsThreeJS.prototype.onDocumentTouchEnd = function(event)
{
    event.preventDefault();
    ...
    if (PickManager)
    {
    	PickManager.handleTouchEnd(evt);
    }

    Application.handleTouchEnd(evt);
}


GraphicsThreeJS.prototype.onKeyDown = function(event)
{
	// N.B.: Chrome doesn't deliver keyPress if we don't bubble... keep an eye on this
	event.preventDefault();

    Keyboard.instance.onKeyDown(event);

	Application.handleKeyDown(event);
}

GraphicsThreeJS.prototype.onKeyUp = function(event)
{
	// N.B.: Chrome doesn't deliver keyPress if we don't bubble... keep an eye on this
	event.preventDefault();

    Keyboard.instance.onKeyUp(event);

	Application.handleKeyUp(event);
}

GraphicsThreeJS.prototype.onKeyPress = function(event)
{
	// N.B.: Chrome doesn't deliver keyPress if we don't bubble... keep an eye on this
	event.preventDefault();

    Keyboard.instance.onKeyPress(event);

	Application.handleKeyPress(event);
}

GraphicsThreeJS.prototype.onWindowResize = function(event)
{
	...
	if (CameraManager && CameraManager.handleWindowResize(this.container.offsetWidth, this.container.offsetHeight))
	{
	}
	else
	{
...
GraphicsThreeJS.prototype.onFullScreenChanged = function(event) {
...
GraphicsThreeJS.prototype.setCursor = function(cursor)
{
	if (!cursor)
...
GraphicsThreeJS.prototype.update = function()
{
...
GraphicsThreeJS.prototype.render = function() {
...
GraphicsThreeJS.prototype.renderVR = function() {
...
GraphicsThreeJS.prototype.renderEffects = function(deltat) {
	this.composer.render(deltat);
}

GraphicsThreeJS.prototype.renderStereo = function() {
	// start with 2 layer to test; will need to work in postprocessing when that's ready
...
GraphicsThreeJS.prototype.enableShadows = function(enable)
{
...
GraphicsThreeJS.prototype.setFullScreen = function(enable)
{
	if (this.riftCam) {
...
GraphicsThreeJS.prototype.setCamera = function(camera) {
	this.camera = camera;
	if (this.composer) {
...
GraphicsThreeJS.prototype.addEffect = function(effect) {
...
GraphicsThreeJS.default_display_stats = false;
